var app = angular.module('PACKEDFAPP', [])
 ...
 .controller('oepnship_CTLR', function ($scope, $http, $interval, $window) {
            ...
            $scope.dispatchOrder = function ()
            {
                ...
                $scope.scan.status_type = $scope.status_type;
                $scope.scan.comments = $scope.comments;
                
                
                $http({
                    url: SITEAPP_PATH+"PackStatus/openorderStatusProcess",
                    method: "POST",
                    data: $scope.scan,
            ...
            $scope.validateOrder = function () {
                ...
                //console.log($scope.scan);
                $http({
                    url: SITEAPP_PATH+"PackStatus/validatePack",
                    method: "POST",
