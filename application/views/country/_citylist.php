...
<tr>
    ...
    <?php // } ?>
    <?php if (GetCourierCompanyStausActive('Roz Express') == 'Y') { ?>
        <td><input type="text" name="rozx_city" id="rozx_city<?php echo $listdata['id']; ?>" placeholder="Roz Express City" value="<?php echo $listdata['rozx_city']; ?>" class="form-control">
            <br>
        ...
        <td><input type="text" name="rozx_city_code" id="rozx_city_code<?php echo $listdata['id']; ?>" placeholder="Roz Express City Code" value="<?php echo $listdata['rozx_city_code']; ?>" class="form-control">
            <br>
    ...
    <?php if (GetCourierCompanyStausActive('Sprint') == 'Y') { ?>
        <td><input type="text" name="sprint_city" id="sprint_city<?php echo $listdata['id']; ?>" placeholder="<?= lang('lang_add_city'); ?>" value="<?php echo $listdata['sprint_city']; ?>" class="form-control">
            <br>
    ...
    <?php if ( GetCourierCompanyStausActive('Nashmi') =='Y') { ?>    
