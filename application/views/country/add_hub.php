                ...
                <div class="content-wrapper">
                    ...
                    <div class="content">
                        <div class="panel panel-flat">
                            <div class="panel-heading"><h1><strong> <?php if(!empty($EditData)){ echo 'Edit';} else { echo 'Add';}?> <?=lang('lang_Hub');?></strong></h1></div>
                            <hr>
                            <div class="panel-body">
                                ...
                                <form action="<?= base_url('country/addhub'); ?>" name="adduser" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="state"><strong><?=lang('lang_Hub');?> <?=lang('lang_Name');?>:</strong></label>
