                    ...
                    <div class="content">
                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body">
                                  <div class="panel-heading" dir="ltr"><h1><strong><?=lang('lang_import_Bulk_location');?></strong><a href="<?= base_url('Excel_export/Importlocation'); ?>"><i class="icon-file-excel pull-right" style="font-size: 35px;"></i></a></h1></div>
...
<?php endif;?>   
                            <div class="alert alert-danger"><strong><?=lang('lang_Note');?> </strong><br>&nbsp1. <?=lang('lang_Toexcel_csvv_file_get_excel_idea_one');?>.<br>&nbsp2.  <?=lang('lang_All_fields_are_required');?>.<br>&nbsp3. <?=lang('lang_Click_above_excel_icon_excel_file_idea');?>.</div>  <hr>
