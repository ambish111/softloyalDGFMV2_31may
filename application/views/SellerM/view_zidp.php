                    ...
                    <div class="content" >
                        ...
                        <div class="panel panel-flat" >
                            ...
                            <div class="panel-body" >
                                    ...
                                    <form method="post" action="<?php echo base_url('Seller/ZidProducts/'.$seller_id); ?>">
                                                <div class="row">
                                                <div class="col-md-3">
                                                 ...
                                                 <div class="col-md-3">
                                                    <div class="form-group ">
                                                        <label for="">Zid ID:</label>
                                                        <input class="form-control" placeholder="Enter Zid ID" type="text" id="search_zid_id" name="search_zid_id">
                                                    </div>
                                                </div> 
                                                <div class="col-md-3">
                                                    <div class="form-group ">
                                                ...
                                                <?php if (!empty($products)): ?>
                                                    ...
                                                    <?php foreach ($products as $key=>$product): ?>
                                                        ...
                                                        //     {
                                                            ...
                                                            <td><input type="hidden" name="skuname[]" value="<?= $product['name']['en']; ?>">
                                                            <input type="hidden" name="description[]" value="<?= $product['slug']; ?>">
                                                            <?php echo $product['name']['en']; ?></td>
