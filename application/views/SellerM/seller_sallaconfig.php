                            ...
                            <div class="panel-body">
                                <form action="<?= base_url('Seller/updateSallaConfig/' . $customer['id']); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <fieldset class="scheduler-border" id="show_salla_details" style="">   
                                        ...
                                        <div class="form-group">
                                            <label>Salla shipping cost</label>
                                            <input type="text" class="form-control" name="salla_shipping_cost" id="salla_shipping_cost" value="<?php echo $customer['salla_shipping_cost']; ?>" autocomplete="off">
                                        </div>
                                        <div class="form-group">
