...
<html lang="en">
                ...
                <div class="content-wrapper" >
                    ...
                    <div class="content" >
                        ...
                        <div class="panel panel-flat" >
                            ...
                            <form method="post" action="<?php echo base_url('Seller/SallaProducts/'.$target_url); ?>">
                                <div class="row">
                                  <div class="col-md-3">
                           ...
                           <!-- <div style="clear: both;">  -->
                            <hr />
                                    ...
                                    <form method="post" action="<?php echo base_url(); ?>Seller/SaveSallaProducts">
                                    <div class="col-md-3">
                                        <div class="form-group ">
   ...
   <input type="submit" class="btn btn-primary pull-right" value="Save SKU" style="margin-top:27px" /> </div>
                                ...
                                <div class="table-responsive" style="padding-bottom:20px;" >
                                                ...
                                                <?php if (!empty($products)): ?>
                                                    ...
                                                    <?php foreach ($products as $key=>$product): ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="hidden" name="image[]" value="<?= $product['image']; ?>"><img src="<?=$product['image'];?>" width="100 px"></td>
                                    ...
                                    <form method="post" id="productForm" action="<?php echo base_url(); ?>Seller/SallaProducts/<?=$seller_id;?>">
                                          <input type="hidden" id="aleradyexist" name="aleradyexist" value="<?=$aleradyexist; ?>">
                                          <?php if (!empty($products)): ?>    
                                        <div class="container">
                                            <div class="col-md-12">

                                            <?php if($current_page<=$total_pages && $count=20){ ?>
                                            <ul class="pagination">
