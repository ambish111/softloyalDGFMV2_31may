                    ...
                    <div class="content">
                                ...
                                <form action="<?= base_url('Seller/edit/' . $customer['id']); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <fieldset class="scheduler-border">
                                       ...
                                       // echo '//'.$customer['u_type'].'//';
                                        ...
                                        if ($customer['hide_email'] == 'Y') {
                                            $checklhide_email = 'checked="checked"';
                                        } else {
                                            $checklhide_email1 = 'checked="checked"';
                                        }
                      ...
                      <input type="radio" name="u_type" id="u_type" value="B2B" <?=$checku_type;?>> Yes <input type="radio" name="u_type" id="u_type"  value="B2C" <?=$checku_type1;?>> No      
                                        ...
                                        <div class="form-group radiosection">
                                            ...
                                            <input type="radio" name="label_info" id="label_info_customer" <?php if($customer['label_info_from'] == '1'){ echo "checked='checked'"; } ?>   value="1" >&nbsp;From Customer 
                                            <input type="radio" name="label_info" id="label_info_shipment"   <?php if($customer['label_info_from'] == '2'){ echo "checked='checked'"; } ?>   value="2">&nbsp;From Shipment      
                                            <!-- <input type="radio" name="label_info" id="label_info_config"   <?php if($customer['label_info_from'] == '3'){ echo "checked='checked'"; } ?>   value="3">&nbsp;From Site Config       -->
                                        </div>  
                                        
                                        <div class="form-group radiosection">
                                            <label ><strong>Email Hide On Label Zid:</strong></label><br>
                                            <input type="radio" name="hide_email" id="hide_email" <?= $checklhide_email; ?>  value="Y"> Yes 
                                            <input type="radio" name="hide_email" id="hide_email1" <?= $checklhide_email1; ?> value="N"> No
                                        </div>                                        
                ...
                <option ng-repeat="cData in citylist"  ng-if="cData.id!='<?=$customer['city'];?>'"  data-select-watcher data-last="{{$last}}" value="{{cData.id}}" >{{cData.city}}</option>
                                    ...
                                    <fieldset class="scheduler-border">
                                        ...
                                        if ($customer['image'] != '')
                                        {
                                              ...
                                              echo'  <div class="form-group"><img src="' . FBASEURL . $customer['image'] . '" width="150"></div>';   
