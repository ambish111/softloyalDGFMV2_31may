...
<html lang="en">
    ...
    <body ng-app="AppManifest" > 
        ...
        <!-- Page container -->
        <div class="page-container" ng-controller="splitView" ng-init="loadMore(1, 0, '<?= $manifest_id; ?>');">
                                                ...
                                                <table class="table table-bordered table-hover" style="width: 100%;">
                                                    ...
                                                    <tbody >
                                                        ...
                                                        <tr style="width: 80%;">
                                                            ...
                                                            <td > <button  class="btn btn-success" ng-if='showButton' ng-click="savedata()" >Save</button></td>
...
<!--                                                    <input ng-if="data.code=='PU'" type="checkbox" value="{{data.id}}" check-list='Items' ng-model="data.Selected" ng-click="checkIfAllSelected()" />
                                            ...
                                            <td><span class="badge badge-danger"  ng-if="data.editSplit==0"  ng-click="shipData[$index].editSplit=1">{{data.split_qty}}</span><input type="number"  class="form-control" ng-if="data.editSplit==1" ng-model="shipData[$index].split_qty" ng-blur="shipData[$index].editSplit=0" string-to-number max="{{data.qty}}"></td>
