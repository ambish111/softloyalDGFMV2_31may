...
<html lang="en">
    ...
    <body ng-app="AppManifest" ng-controller="Ctrmanifest" ng-init="loadMore(1, 0,'yes');">
                                                ...
                                                <table class="table table-bordered table-hover" style="width: 100%;">
                                                    ...
                                                    <tbody >
                                                        ...
                                                        <option value="OLD"><?= lang('lang_Oldest_Order'); ?></option>
                                                            ...
                                                            <td><button  class="btn btn-danger" ng-click="loadMore(1, 1,'yes');" ><?= lang('lang_Search'); ?></button></td>
                                        ...
                                        <tr ng-if='shipData != 0' ng-repeat="data in shipData"> 
                                           ...
                                           <td width="200"><span class="badge badge-success" title="Total">{{data.qtyall}}</span> <!--&nbsp;<span class="badge badge-danger">2</span>--></td>
                                            ...
                                            <td ng-if="data.manifest_type == null"><span class="badge badge-warning">{{data.description}} </span></td>
                                              ...
                                              <td ><span ng-if="data.assign_date!='0000-00-00 00:00:00'">{{data.assign_date}}</span>
                                              <span ng-if="data.assign_date=='0000-00-00 00:00:00'">--</span>
                                              </td>
...
<!--                                                            <li ><a href="manifestview/{{data.uniqueid}}/PS"><i class="icon-eye" ></i><?= lang('lang_Pending'); ?> <?= lang('lang_Sku'); ?></a></li>-->
                                                            <li ><a href="<?=base_url();?>manifestview/{{data.uniqueid}}/RS"><i class="icon-eye" ></i> View <?= lang('lang_Sku'); ?></a></li>
<!--                                                            <li ><a href="manifestview/{{data.uniqueid}}/DM"><i class="icon-eye" ></i><?= lang('lang_Damage'); ?> Or <?= lang('lang_Missing'); ?> <?= lang('lang_Sku'); ?></a></li>-->
 ...
 <li ng-if="data.confirmO == 'N' && data.addBtnI == 'N' && data.r_qty>0 && data.error == '0'"><a href="<?=base_url();?>stocks/updateManifest/{{data.uniqueid}}" ><i class="icon-pencil7"></i><?= lang('lang_Add_Inventory'); ?></a></li>
                                                            
<!--                                                              <li ng-if="data.confirmO == 'N' && data.addBtnI == 'N' && data.complatedqty == data.qtyall && data.error == '0'"><a ng-confirm-click="are you sure to add items?" confirmed-click="showconfirmorder_pop(data.uniqueid,data.sid);"  ><i class="icon-pencil7"></i><?= lang('lang_Add_Inventory'); ?></a></li>-->
                                    ...
                                    <button ng-hide="shipData.length == totalCount" class="btn btn-info" ng-click="loadMore(count = count + 1, 0,'yes');" ng-init="count = 1"><?= lang('lang_Load_More'); ?></button>
                                </div>
                                <hr>
                            </div>
                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form novalidate ng-submit="myForm.$valid && getsaveconfirmOrders()" name="myForm" >
                                ...
                                <div class="alert alert-warning" ng-if="shelveError" > this 
                                  Shelve no  #{{$data.shelveNo}} is already use 
                                </div>
                                ...
                                <div ng-repeat="data in Updateqtyconf.result">
                                    <table class="table table-striped table-hover table-bordered dataTable bg-*" style="width:100%;"><tr>
                                      ...
                                      <tr>
                                            <td><?= lang('lang_Shelve_No'); ?></td><td><input class="form-control" my-enter="check_shelve();" type="text" ng-model="data.shelveNo"></td></tr>
                                        <tr>
