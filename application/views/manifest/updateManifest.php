...
<html lang="en">
    <head>
        ...
        <script src='<?= base_url(); ?>assets/js/angular/updateManifest.js?token=<?=time();?>'></script>
...
<?php exit; } ?>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <a class="btn btn-success" ng-show="AddInventoryBtn" ng-confirm-click="Are you sure want Add Inventory?"  confirmed-click="GetSaveReportInventpry('<?=$result[0]['uniqueid'];?>');" >Add Inventory </a>
