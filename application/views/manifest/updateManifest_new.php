...
<html lang="en">
    <head>
        ...
        <script src='<?= base_url(); ?>assets/js/angular/updateManifest_new.js?v=<?= time(); ?>'></script>
                                        ...
                                        <div class="col-lg-12">
                                                    ...
                                                    <?php if (!empty($result)) { ?>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="selectpicker" data-show-subtext="true" data-live-search="true" ng-disabled="cust_nameBtn"   ng-model="scan.sku" ng-change="scan_sku();">

                                                                    <option value="">Select Sku</option>

                                                                    <option ng-repeat="s_data in skuLoopArr" data-select-watcher data-last="{{$last}}" value="{{s_data.sku}}">{{s_data.sku}}</option>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="downloadtable">
                                                        <thead>
                                                            <tr>
                                                                <th class="head1">Total QTY</th><td><span class="badge badge badge-pill badge-success" >{{Menidata[0].totalqty_new}}</span></td>
                                                               <th class="head0">Missing QTY</th><td><span class="badge badge badge-pill badge-danger" >{{Menidata[0].missing_qty}}</span></td>
                                                                 <th class="head0">Damage QTY</th><td><span class="badge badge badge-pill badge-danger" >{{Menidata[0].damage_qty}}</span></td>
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover" id="downloadtable">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="head1">SKU Size</th>
                                                                <th class="head0">Fill QTY</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr   ng-repeat="data in Menidata"> <!--|reverse -->
                                                                ...
                                                                <td>  <span class="badge badge badge-pill badge-success" >{{data.capacity}}</span></td>
                                                                <td>  <span class="badge badge badge-pill badge-success" >{{data.filled}}</span></td>
                                                               

                                                                <td>  <span class="badge badge badge-pill badge-warning" >{{data.storage_type}}</span></td>
                                                                <td>
                                                                    <input type="text" ng-if="data.scaned == 0" class="form-control"  my-enter="GetcheckStockLocation(Menidata[$index],$index);"  ng-model="Menidata[$index].stockLocation"> 
                                                                    <span ng-if="data.scaned == 1" class="badge badge badge-pill badge-success" >{{data.stockLocation}}</span>
                                                                    <i class="fa fa-undo" ng-if="data.scaned == 1"   ng-click="openStockLocation($index)" style="margin-top: 13px;" ></i> 

                                                                </td>

                                                                <td><input type="text" ng-if="data.scaned_s == 0" class="form-control" my-enter="GetcheckshelvekLocation(Menidata[$index],$index);" ng-model="Menidata[$index].shelveNo">
                                                                    <span ng-if="data.scaned_s == 1" class="badge badge badge-pill badge-success" >{{data.shelveNo}}</span>
                                                                <i class="fa fa-undo" ng-if="data.scaned_s == 1"   ng-click="openshelveLocation($index)" style="margin-top: 13px;" ></i> 
                                                                </td>
