...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="<?= base_url(); ?>assets/js/angular/damagehistory.app.js"></script>
    ...
    <body ng-app="AppReports">
        ...
        <!-- Page container -->
        <div class="page-container" ng-controller="DamageHIstory" ng-init="loadMore(1, 0);">  
