...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="<?= base_url(); ?>assets/js/angular/reports.app.js?v=<?=time();?>"></script>
                                            ...
                                            <table class="table table-bordered table-hover" style="width: 100%;">
                                                ...
                                                <tbody >
                                                    ...
                                                    <tr style="width: 80%;">
                                                        ...
                                                        <td ><div class="form-group" ><strong>Return Status:</strong><br/>

                                                                <select  id="return_status" name="return_status"  ng-model="filterData.return_status"   class="form-control" data-width="100%" >
                                                    ...
                                                    <tr style="width: 100%;">	
                                                        ...
                                                        <td colspan="1" ng-if="Items.length>0">
                                                            <button  class="btn btn-warning" confirmed-click="GetConfirmStatus();" ng-confirm-click="Do you confirm?" style="margin-left: 7%" >Confirm</button</td>

                                                        <td colspan="1" ng-if="Items.length>0"> <button  class="btn btn-danger"  style="margin-left: 7%" >Selected {{Items.length}} </button></td>
                                                    </tr>
                                    ...
                                    <table class="table table-striped table-hover table-bordered dataTable" id="printTable" style="width:100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr ng-if='shipData != 0' ng-repeat="data in shipData">
                                                <td>{{$index + 1}} <input ng-if="data.return_status=='N'" type="checkbox" value="{{data.id}}" check-list='Items' ng-model="data.Selected" ng-click="checkIfAllSelected()" />
                                                
                                                    <input ng-if="data.return_status=='Y'" disabled="disabled" type="checkbox"   />
                                                </td>
                                                <td>{{data.order_no}}</td>
                                                <td>{{data.name}}</td>
`
                                                ...
                                                <td>
                                                    <a onclick="return confirm('Are you sure?')" href="<?= base_url(); ?>dr_status/{{data.id}}"  class="btn btn-danger" ng-if="data.return_status == 'N'" >Confirm</a>
                                                    <span class="badge badge-success"  ng-if="data.return_status == 'Y'">Yes</span></td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 row">
                                    ...
                                    <div class="col-sm-4">
                                     ...
                                     <div class="col-sm-4">
                                        <label class="container">
                                            <input type="checkbox" name="return_status" value="return_status"  ng-model="listData2.return_status"> Return Status
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
