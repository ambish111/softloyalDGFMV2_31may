                            ...
                            <div class="col-lg-12" >
                                ...
                                <div class="panel panel-flat">
                                    <div class="panel-heading">
                                        <h1> <strong>Bulk SMS</strong> </h1>
                                    </div>
                                    <div class="panel-body">
                                        <div class="row"> </div>
                                        <div class="alert alert-danger"><?=lang('lang_Note');?> <?=lang('lang_Order_Limit_is_Hundred');?></div>
                                        <form  method="post" action="<?= base_url(); ?>BulkSms/Smssend" target="_blank" >
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <textarea rows="8" id="show_awb_no" name="show_awb_no" style="height:150px;" placeholder="<?=lang('lang_Please_Enter_Your_AWB_Number');?>" required class="form-control"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <textarea rows="8" id="show_SMS" style="height:150px;" name="show_SMS"  placeholder="Please Enter Your SMS" required class="form-control"></textarea>
                                                </div>
                                            </div>
                                             <div class="col-md-1" >
                                                <div class="form-group">
                                               ...
                                               <div class="col-md-2" >
                                                <div class="form-group">
                                                    ...
                                                    <input type="submit" name="print_ready" class="btn btn-primary form-control checkdisable" value="Send SMS">	 
