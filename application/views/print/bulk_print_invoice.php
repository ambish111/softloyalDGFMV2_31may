                            ...
                            <div class="col-lg-12" >
                                ...
                                <div class="panel panel-flat">
                                    <div class="panel-heading">
                                        <h1> <strong><?= lang('lang_Bulk_Print'); ?> International invoice</strong> </h1>
                                    </div>
                                    <div class="panel-body">
                                        <div class="row"> </div>
                                        <div class="alert alert-danger"><?= lang('lang_Note'); ?> <?= lang('lang_Order_Limit_is_Hundred'); ?></div>
                                        <form  method="post" action="<?= base_url(); ?>Print_I/BulkPrintInvoice" target="_blank" >
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-3" >
                                                <div class="form-group">
                                                    <input type="submit" name="invoice_print" class="btn btn-primary form-control checkdisable" value="PRINT">	
                                                </div> 
                                            </div>
