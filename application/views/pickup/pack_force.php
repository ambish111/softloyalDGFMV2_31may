...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="<?= base_url('assets/js/angular/packed_force.app.js?token=' . time()); ?>"></script>

    </head>
    

    <body ng-app="PACKEDFAPP" ng-controller="oepnship_CTLR"  >
                                ...
                                <div class="panel panel-flat">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12" >
                                            ...
                                            <div  ng-if="invalidstring" ><div class="alert alert-danger">list of Not Delivered Orders:{{invalidstring}}</div>
                                    ...
                                    <div class="table-responsive " >
                                        ...
                                        <form ng-submit="dispatchOrder();" method="post" >
                                            ...
                                            <div class="col-md-2">	
                                                ...
                                                <div class="form-group">
                                                    <select ng-model="type" class="form-control">
                                                        ...
                                                        <option value="PK" >Pack Force</option>
                                            ...
                                            <div class="col-md-3">	
                                                ...
                                                <div class="form-group">
                                                    <select ng-model="status_type" class="form-control">

                                                        <option value="RDM" >Remove Delivery Manifest</option>
                                                        <option value="WDM" >Without Delivery Manifest</option>
                                            ...
                                            <div class="col-md-2">	
                                                ...
                                                <div class="form-group">
                                                    <textarea type="text" class="form-control" ng-model="comments" placeholder="Enter Comment" required="required"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-2">	
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <button type"submit" ng-if="scan.awbArray == null"  role="button" class="btn btn-info form-control" disabled >Update </button>	
