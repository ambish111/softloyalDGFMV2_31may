                        ...
                        <div class="">
                            <div class="panel panel-flat">
                                <div class="panel-heading">
                                    <h5 class="panel-title">Order Picking </h5>
<!--                                     <h1 id="tabnum">0</h1>
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div ng-repeat="error in error_sku"><div  class="alert alert-warning"> This Item {{error.sku}} {{error.error}} </div></div>
                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="show_messanger_print1">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="head0">In Stock Location</th>
                                                            <th class="head0">In Stock</th>

                                                            <th class="head0">Scan Stock Location</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr   ng-repeat="data in shipData">
                                                            ...
                                                            <td>{{$index + 1}}</td>
<!--                                                             <td><span class="label label-success" ng-if="data.offer=='Yes'">{{data.pcode}}</span>
                                                            <span class="label label-warning" ng-if="data.offer=='No'">No</span>
                                                            </td>-->
                                                            ...
                                                            <td>  <span class="badge badge badge-pill badge-warning" >{{data.st_location}}</span></td>
                                                             <td><span class="badge badge badge-pill badge-danger" >{{data.quantity}}</span></td>
                                                            <td>
                                                                <input ng-if="data.scan_s == 0" type="text" my-enter="GetcheckStocklocation_new(shipData[$index],$index);" class="form-control" ng-model="shipData[$index].stock_location">
