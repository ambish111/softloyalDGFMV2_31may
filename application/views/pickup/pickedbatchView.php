...
<!--                   	  <th class="head1">Remove</th>--> 
                                                 ...
                                                 <button ng-hide="SingeListArr.length == totalCount" class="btn btn-info" ng-click="GetlistbatchpickingView(count = count + 1, 0);" ng-init="count = 1"><?=lang('lang_Load_More');?></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
