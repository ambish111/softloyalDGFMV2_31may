                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" ng-disabled="mainAWBBtn"  my-enter="scan_awb();" ng-model="scan.slip_no"class="form-control" placeHolder='AWB' />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="scan_awb" my-enter="packuShip()" ng-model="scan.sku" class="form-control" placeHolder='EAN NO.' />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2" >
                                                        <div class="form-group">
