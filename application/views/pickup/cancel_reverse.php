...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="<?= base_url('assets/js/angular/openshipment.app.js?token=' . time()); ?>"></script>
                            ...
                            <div class="col-lg-12" >
                                ...
                                <div class="panel panel-flat">
                                    <div class="panel-heading">
                                        <h1>
                                            <strong>Cancel Reverse Order</strong>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12" >
                                        <div  ng-if="invalidstring" ><div class="alert alert-danger">list of Not Reverse Orders:{{invalidstring}}</div>
                                    ...
                                    <div class="table-responsive " >
                                        ...
                                        <form ng-submit="cancelorderProcess();" method="post" >
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <textarea rows="8" id="show_awb_no" ng-change="scan_awb_cancel();"   ng-model="scan.slip_no" required class="form-control"></textarea>
