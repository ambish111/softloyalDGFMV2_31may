...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="<?= base_url('assets/js/angular/openshipment_og.app.js?token=' . time()); ?>"></script>

        
    </head>

    <body ng-app="OpenshipAPP" ng-controller="oepnship_CTLR"  >
                            ...
                            <div class="col-lg-12" >
                                ...
                                <div class="panel panel-flat">
                                    <div class="panel-heading">
                                        <h1>
                                            <strong>Update under review</strong>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12" >
                                            ...
                                            <div  ng-if="invalidstring" ><div class="alert alert-danger">list of Not Under Review Orders:{{invalidstring}}</div>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div ng-if="awbArray.length > 200" class="alert alert-danger"> Error! shipment limit Exceed Please Add less then 200 </div>
        ...
        <script>
                    ...
                    function validationCheck()
                    {
                        ...
                        if (count > 200)
                        {
                            document.getElementById('message_scan').innerHTML = '<div class="alert alert-danger" id="success-alert">Error! shipment limit Exceed Please Add less then 200</div>';
                            valid_check = 1;
