...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="<?= base_url('assets/js/angular/onhold.app.js?token=' . time()); ?>"></script>

    </head>

    <body ng-app="OnholdAPp" ng-controller="onholdview_CTLR"  >
                                ...
                                <div class="panel panel-flat">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12" >
                                            ...
                                            <div  ng-if="invalidstring" ><div class="alert alert-danger">list of Not Valid Orders:{{invalidstring}}</div>
                                    ...
                                    <div class="table-responsive " >
                                        ...
                                        <form ng-submit="updateonhold();" method="post" >
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">	
                                                ...
                                                <div class="form-group">
                                                    <select ng-model="type" class="form-control">
                                                        ...
                                                        <option value="No" >Remove On Hold</option>
