...
<script src="<?=base_url();?>assets/js/angular/picked.app.js?auth=<?=time();?>"></script>
              ...
              <div class="panel-body">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <input type="text" id="" my-enter="scan_awb();" ng-model="scan.slip_no"class="form-control" placeHolder='EAN No.' />
                  </div>
                </div>
                  <div class="col-md-3">
            ...
            <table class="table-striped table-bordered table-hover" role="table" id="show_messanger_print1">
              <thead role="rowgroup">
                <tr role="row">
                  ...
                  <th class="head1" role="columnheader">EAN NO.</th>
                  <th class="head0" role="columnheader">SKU</th>
             ...
             <tbody role="rowgroup" >
                <tr   ng-repeat="data in shipData|reverse " role="row">
                 ...
                 <td role="cell"><span class="label label-info">{{data.sku}}</span></td>
                  <td role="cell"><span class="label label-info">{{data.ean_no}}</span></td>
                <td role="cell">
                <table role="table">
...
@media
    ...
    tr:nth-child(odd) {
	 ...
	 td:nth-of-type(2):before { content: "EAN NO."; }
         td:nth-of-type(3):before { content: "SKU"; }
         td:nth-of-type(4):before { content: "Ref. No."; }
	td:nth-of-type(5):before { content: "Total"; }
        td:nth-of-type(6):before { content: "Scaned"; }
