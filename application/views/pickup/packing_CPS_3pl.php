...
<html lang="en">
    <head>
        ...
        <script src='<?= base_url(); ?>assets/js/angular/packing_cps.app.js?token=<?= time(); ?>'></script>
                        ...
                        <div class="page-header page-header-default">
                            <div class="page-header-content">
                                <div class="page-title">
                                    <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold"><?= lang('lang_Packaging'); ?> CPS 3PL</span> </h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="">
                            ...
                            <div class="panel panel-flat">
                                <div class="panel-heading">
                                    <h5 class="panel-title"><?= lang('lang_Order_Packaging'); ?> CPS 3PL</h5>
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" ng-disabled="mainAWBBtn"  my-enter="scan_cps_fwd();" ng-model="scan.slip_no"class="form-control" placeHolder='3PL' />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="scan_awb" my-enter="packuShip_fwd()" ng-model="scan.sku" class="form-control" placeHolder='EAN NO.' />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2" >
                                                        <div class="form-group">

                                                            <input type="text" id="cps_id"  my-enter="scanCPSnumber()" ng-model="scan.cps_id" class="form-control" placeHolder='Serial' />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group"  ng-if="completeArray.length > 20">
                                                            <input type="button" ng-click="finishScanFwd();" value='<?= lang('lang_Verify'); ?> 'class="btn btn-danger" />
                                                        </div>
                                                        <div class="form-group" ng-if="completeArray.length <= 20">


                                                            <input type="button" ng-click="finishScanFwd();" value='<?= lang('lang_Verify'); ?> 'class="btn btn-primary" />
                                                        </div>
