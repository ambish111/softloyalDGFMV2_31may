...
<html lang="en">
    ...
    <body ng-app="fulfill" >
        ...
        <!-- Page container -->
        <div class="page-container" ng-controller="scanShipment_tods">
                        ...
                        <div class="">
                            <div class="panel panel-flat">
                                <div class="panel-heading">
                                    <h5 class="panel-title"><?=lang('lang_Order_Packaging_With_TOD');?></h5>
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="" my-enter="scan_awb();" ng-model="scan.slip_no"class="form-control" placeHolder='TOD' />
                                                        </div>
                                                    </div>
...
<!--                   	  <th class="head1">Remove</th>-->
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr   ng-repeat="data in shipData|reverse ">
                                                            <td>{{$index + 1}}</td>
                                                            <td><span class="label label-primary">{{data.slip_no_check}}</span></td>
                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="show_messanger_print">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr   ng-repeat="data in completeArray">
                                                            ...
                                                            <td>{{data.slip_no_check}}</td>
                                                            <td>{{data.frwd_company_id}}</td>
                                                            <td>{{data.frwd_company_awb}}</td>
                                                            <td><a class="btn btn-success" href="{{data.print_url}}" target="_blank"><?=lang('lang_Print');?></a></td>
                                                        </tr>
