...
<html lang="en">
    <head>
        ...
        <script src="<?= base_url(); ?>assets/js/angular/salla_app.js"></script>
    </head>

    <body ng-app="SallaAppPage" >
        <?php $this->load->view('include/main_navbar'); ?>

        <!-- Page container -->
        <div class="page-container"  ng-controller="SallaAppCRL"> 
                            ...
                            <div class="col-lg-12" > 
                                ...
                                <div class="panel panel-flat">
                                    <div class="panel-heading">
                                        <h1> <strong>Push Delivered Status in Salla</strong> </h1>
                                    </div>
                                    <div class="panel-body">

                                        <div class="card-body">
                                        <div class="alert alert-danger"><strong><?=lang('lang_Note');?> ! </strong><br>&nbsp1. Only <strong>Delivered (POD) </strong>Shipment will be push in Salla.<br>&nbsp2. <?=lang('lang_Dublicates_Orders_are_automatically_removed');?>.<br>&nbsp3. You can push 20 shipments at a time</div>  <hr>
                                            <!-- <div class="clearfix">
                                                <span class="badge badge badge-pill badge-danger" id="count_val"><? //=lang('lang_Dublicates_Orders_are_automatically_removed');?></span>
                                                </br>
                                                <span class="badge badge badge-pill badge-danger" id="count_val">Only Delivered Shipment will be push in Salla.</span>
                                                </br>
                                                <span class="badge badge badge-pill badge-danger mt-10" id="count_val">You can push 20 shipments at a time.</span> 
                                            </div>   -->
                                            <div class="row" style="margin-top:10px">
                                                ...
                                                <div class="col-md-12" ng-if="Success_msg">
                                                    <div class="alert alert-success" ng-repeat="success_msg in Success_msg">{{success_msg}} : Salla Status Updated.</div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2" style="margin-bottom: 11px;">   
                                                    <label>&nbsp;</label>
                                                    <button type="submit" class="btn btn-primary form-control" ng-click="BulkPushSallaStatus();"><?=lang('lang_Submit');?> </button>
                                                </div>
                                            </div>
