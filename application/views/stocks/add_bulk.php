            ...
            <div class="content-wrapper">
                ...
                <div class="content">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading" dir="ltr"><h1><strong><?=lang('lang_Bulk_Upload');?></strong><a href="<?= base_url('Stocks/Inventory_bulk_format');?>"><i class="icon-file-excel pull-right" style="font-size: 35px;"></i></a></h1></div>
                ...
                <tbody>
                    ...
                    <tr>
                     ...
                     <tr>
                      <td>(7) Stock Location. <span style="color:#F00"><strong>*</strong></span></td>
                ...
                <form class="stdform" id="AddnventoryID" method="post" action="<?= base_url('Stocks/add_ItemInventory_bulk');?>" name="AddnventoryID" enctype="multipart/form-data" onsubmit="document.getElementById('Newaddfrm').disabled=true; processFormData();">
