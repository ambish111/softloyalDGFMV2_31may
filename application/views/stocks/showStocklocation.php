...
<html lang="en">
    <head>
        ...
        <script src="<?=base_url();?>assets/js/angular/stocklocation_new.js?v=<?=time();?>"></script>
                        ...
                        <div class="panel panel-flat"  >
                            ...
                            <div class="panel-heading"> 
                                ...
                                <h1><strong><?php if($type1=='AS') echo 'Assigned '; else if($type1=='UN') echo 'Unassigned'; else echo 'Show';?> <?= lang('lang_Stock_Location'); ?> </strong>
                                    ...
                                    <a  ng-click="exportlocation();" >
                                                <i class="icon-file-excel pull-right" style="font-size: 35px; margin-top:3px;"></i></a>
                                            <select id="exportlimit" class="custom-select pull-right" ng-model="filterData.exportlimit" name="exprort_limit" required="" style="    font-size: 16px;padding: 5px;margin-right: 10px;margin-top: 3px;" >
