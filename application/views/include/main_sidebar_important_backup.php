...
<!--                    <li  <?php if ($this->uri->segment(1) == 'Home' || $this->uri->segment(1) == '') echo 'class="active"'; ?>>
                    ...
                    <?php if (menuIdExitsInPrivilageArray_check(1,$LeftFmenuArr) == 'Y') { ?>
                        <li <?php if ($this->uri->segment(1) == 'Shipment' || $this->uri->segment(1) == 'bulk_update_view' || $this->uri->segment(1) == 'TrackingResult' || $this->uri->segment(1) == 'TrackingDetails' || $this->uri->segment(1) == 'Forward_Delivery_Station' || $this->uri->segment(1) == 'bulkprint' || $this->uri->segment(1) == 'forwardshipments' || $this->uri->segment(1) == 'forwardedshipments' || $this->uri->segment(1) == 'bulk_tracking' || $this->uri->segment(1) == 'Backorder' || $this->uri->segment(1) == 'OpenShipment' || $this->uri->segment(1) == 'cod_update_3pl' || $this->uri->segment(1) == 'OpenShipment' || $this->uri->segment(1) == 'cancelReverseOrder' || $this->uri->segment(1) == 'Onhold') echo 'class="active"'; ?>> <a href="#"><i class="icon-bus"></i> <span><?= lang('lang_Shipment_Management'); ?></span></a>
                            <ul>
                        ...
                        <li <?php if ($this->uri->segment(2) == 'AddofferGift' || $this->uri->segment(2) == 'giftOffersList' || $this->uri->segment(2) == 'giftOffersList' || $this->uri->segment(2) == 'edit_offer_gift' || $this->uri->segment(2) == 'packing_b2b') echo 'class="active"'; ?>> <a href="#"><i class="icon-gift"></i> <span> <?= lang('lang_Packaging_Management'); ?> </span></a>
                            <ul>
                                ...
                                <?php } ?>
                                    ...
                                    <li <?php if ($this->uri->segment(1) == 'packing_ean') echo 'class="active"'; ?>> <a href="<?= base_url('packing_ean'); ?>"></i> <span><?= lang('lang_Packaging'); ?></span></a> </li>
                                <?php } ?>
    ...
    <!--                        <li <?php if ($this->uri->segment(1) == 'Stocks' || $this->uri->segment(2) == 'bulk_location' || $this->uri->segment(1) == 'showStocklocation' || $this->uri->segment(2) == 'show_manifest' || $this->uri->segment(1) == 'stockInventory' || $this->uri->segment(1) == 'Shipment_og' || $this->uri->segment(1) == 'Backorder_new' || $this->uri->segment(1) == 'inventory_check_new') echo 'class="active"'; ?>>
                    ...
                    <?php if (menuIdExitsInPrivilageArray_check(151,$LeftFmenuArr) == 'Y' && $this->system_type == 'old') { ?>
                        <li> <a type="button"  href="<?= base_url(); ?>Backorder" class="btn btn-danger" style=" margin-left: 2%; margin-right: 3%; "><?= lang('lang_Back_Order'); ?> 
    <!--                                <span class="badge"><?php echo statusCount_back(); ?></span>-->
                            </a> </li>
                    <?php } ?>
                    <?php if (menuIdExitsInPrivilageArray_check(151,$LeftFmenuArr) == 'Y' && $this->system_type == 'new') { ?>
                        <li> <a type="button"  href="<?= base_url(); ?>Backorder_new" class="btn btn-danger" style=" margin-left: 2%; margin-right: 3%; "><?= lang('lang_Back_Order'); ?>
    ...
    <!--                                <span class="badge"><?php echo statusCount_back(); ?></span>-->
                    ...
                    <?php if (menuIdExitsInPrivilageArray_check(80,$LeftFmenuArr) == 'Y' && $this->system_type == 'old') { ?>
                        <li > <a type="button" href="<?= base_url(); ?>ordergenerated" class="btn btn-warning" style="margin-left: 2%; margin-right: 3%"><?= lang('lang_OrderGenerated'); ?>
    <!--                                <span class="badge"><?php echo statusCount(11); ?></span>-->
                            </a> </li>


                    <?php } ?>
                    <?php if (menuIdExitsInPrivilageArray_check(80,$LeftFmenuArr) == 'Y' && $this->system_type == 'new') { ?>
                        <li > <a type="button" href="<?= base_url(); ?>Shipment_og/ordergeneratedView" class="btn btn-warning" style="margin-left: 2%; margin-right: 3%"><?= lang('lang_OrderGenerated'); ?> 
    <!--                                <span class="badge"><?php echo statusCount(11); ?></span>-->
                            </a> </li>
                    ...
                    <?php if (menuIdExitsInPrivilageArray_check(13,$LeftFmenuArr) == 'Y') { ?>
                        <li > <a type="button" href="<?= base_url(); ?>orderCreated" class="btn btn-primary" style="margin-left: 2%; margin-right: 3%"><?= lang('lang_OrderCreated'); ?>
    <!--                                <span class="badge"><?php echo statusCount(1); ?></span> -->
                            </a></li>
                    <?php } ?>
                    <?php if (menuIdExitsInPrivilageArray_check(14,$LeftFmenuArr) == 'Y') { ?>
                        <li> <a type="button"  href="<?= base_url(); ?>pickupList" class="btn btn-warning" style="margin-left: 2%; margin-right: 3%"><?= lang('lang_Pick_List'); ?>
    <!--                                <span class="badge"><?php echo statusCount(2); ?></span> -->
                            </a> </li>
                    <?php } ?>
                    <?php if (menuIdExitsInPrivilageArray_check(15,$LeftFmenuArr) == 'Y') { ?>
                        <li> <a type="button"  href="<?= base_url(); ?>packed" class="btn btn-info" style="margin-left: 2%; margin-right: 3%"><?= lang('lang_Packed'); ?> 
    <!--                                <span class="badge"><?php echo statusCount(4); ?></span> -->
                            </a></li>
                    <?php } ?>

                    <?php if (menuIdExitsInPrivilageArray_check(16,$LeftFmenuArr) == 'Y') { ?>
                        <li> <a type="button"  href="<?= base_url(); ?>dispatched" class="btn btn-success" style=" margin-left: 2%; margin-right: 3%; "><?= lang('lang_Dispatched'); ?> 

    <!--                                <span class="badge"><?php echo statusCount(5); ?></span>-->
                            </a></li>
                    <?php } ?>
                    <?php if (menuIdExitsInPrivilageArray_check(103,$LeftFmenuArr) == 'Y') { ?>
                        <li> <a type="button"  href="<?= base_url(); ?>delivery_manifest" class="btn btn-warning" style=" margin-left: 2%; margin-right: 3%; "><?= lang('lang_delivery_Manifest'); ?> 
    <!--                                <span class="badge"><?php echo ManifeststatusCount(); ?></span>-->
                            </a> </li>
                    <?php } ?>
                    <?php if (menuIdExitsInPrivilageArray_check(104,$LeftFmenuArr) == 'Y') { ?>
