...
<?php /*$notiArr=system_notification_for_inactive();?>
<?php $this->load->view('include/notificationdiv',['notiArr'=>$notiArr]); ?>
<?php  if(!empty($notiArr)){ echo '<div class="navbar navbar-inverse" style="background-color:#0B70CD; z-index: 1;margin-top: 47px;">';} 
else {
    echo '<div class="navbar navbar-inverse" style="background-color:#0B70CD;">';
} */
    ?>
...
<?= $this->session->userdata('user_details')['username']; ?>
                ...
                <ul class="dropdown-menu dropdown-menu-right" style="width: 229px;">
                                        <li><a href="<?= base_url(); ?>lessqty_alert"><span class="label bg-warning-400 pull-right"></span> <i class="icon-alert"></i> <?= lang('lang_Less_Quantity'); ?></a></li> 

                                        

                    <li><a href="<?= base_url(); ?>expiry_alert"><span class="label bg-warning-400 pull-right"></span> <i class="icon-alert"></i> <?= lang('lang_Expiry_Days'); ?></a></li>
                   
                    <li title="New Manifest"><a href="<?= base_url(); ?>shownewmanifestRequest"><span class="label bg-warning-400 pull-right"></span> <i class="icon-alert"></i> <?= lang('lang_New_Manifest'); ?></a></li>
                     <li title="Not Picked Manifest"><a href="<?= base_url(); ?>showpickuplist"><span class="label bg-warning-400 pull-right"></span> <i class="icon-alert"></i> <?= lang('lang_Not_Picked_Manifest'); ?></a></li>
                      <li title="Not Stock Update"><a href="<?= base_url(); ?>showmenifest"><span class="label bg-warning-400 pull-right"></span> <i class="icon-alert"></i><?= lang('lang_Not_Stock_Update'); ?></a></li>
                      
                  <li title="Not Closed Manifest"><a href="<?= base_url(); ?>show_assignedlist"><span class="label bg-warning-400 pull-right"></span> <i class="icon-alert"></i> <?= lang('lang_Not_Closed_Manifest'); ?></a></li>
                       <li title="Open Ticker FF"><a href="<?= base_url(); ?>showTicketview"><span class="label bg-warning-400 pull-right"></span> <i class="icon-alert"></i> <?= lang('lang_Open_Ticket_FF'); ?></a></li>
                         <li title="Open Ticker Manifest"><a href="<?= base_url(); ?>showTicket"><span class="label bg-warning-400 pull-right"></span> <i class="icon-alert"></i> <?= lang('lang_Open_Ticket_Manifest'); ?></a></li>
