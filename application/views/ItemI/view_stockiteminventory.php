...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="<?= base_url(); ?>assets/js/angular/stockinventory.app.js?v=<?=time();?>"></script>
    ...
    <body ng-app="Appiteminventory">
        ...
        <!-- Page container -->
        <div class="page-container" ng-controller="CtritemInvontaryview" ng-init="loadMore_stock(1, 0);">  
                ...
                <div class="content-wrapper" > 
                    ...
                    <div class="content" > 
                        ...
                        if (!empty($this->session->flashdata('messarray')['pallets'])) {
                            echo '<div class="alert alert-warning">invalid Shelve row ' . implode(',', $this->session->flashdata('messarray')['pallets']) . ' <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>';
                        }
                        ...
                        if (!empty($this->session->flashdata('messarray')['emptysku'])) {
                         ...
                         if (!empty($this->session->flashdata('messarray')['empty_stocation'])) {
                            echo '<div class="alert alert-warning">Stock location are empty this row '. implode(',', $this->session->flashdata('messarray')['empty_stocation']) . '  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>';
                        }
                        
                        if (!empty($this->session->flashdata('messarray')['invalid_location'])) {
                            echo '<div class="alert alert-warning">Invalid Stock location '. implode(',', $this->session->flashdata('messarray')['invalid_location']) . '  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>';
                        }
...
<!-- <i class="icon-file-excel pull-right" style="font-size: 35px;"></i> --> 
                                                ...
                                                <tbody >
                                                    ...
                                                    <tr style="width: 80%;">
                                                        ...
                                                        <td ><div class="form-group"><strong><?= lang('lang_From'); ?>:</strong>
                                                                <input class="form-control date ng-pristine ng-valid ng-empty ng-touched" id="from" name="from" ng-model="filterData.from">
                                                                <!-- <input class="form-control date ng-pristine ng-valid ng-empty ng-touched" id="exact" name="exact" ng-model="filterData.exact"> -->
                                                            </div></td>
                                                        <td><div class="form-group" ><strong><?= lang('lang_To'); ?>:</strong>
                                                                <input class="form-control date ng-pristine ng-valid ng-empty ng-touched" id="to"name="to" ng-model="filterData.to" class="form-control">
                                                            </div></td>
                                                        <td><div class="form-group" ><strong><?= lang('lang_Exactdate'); ?>:</strong>
                                                                <input class="form-control date ng-pristine ng-valid ng-empty ng-touched" id="exact"name="exact"  ng-model="filterData.exact" class="form-control">
                                                            </div></td>
                                                    </tr>
                                                    <tr style="width: 80%;">
   ...
   <!--  <input type="date" id="expity_date" name="expity_date" ng-model="filterData.expity_date"  class="form-control" placeholder="Enter Expirty date.">-->
                                                    ...
                                                    <tr>
                                                        <td colspan="1"> <button  class="btn btn-danger" ng-click="loadMore_stock(1, 1);" style="margin-left: 7%" ><?= lang('lang_Search'); ?></button></td>
                                                    </tr> 
                                                </tbody>
                                            </table>
                                            <br>
                            ...
                            <div class="panel-body" > 
                              <!-- <input type="text" value="{{data1.sku}}" id="check" style="display: none;" name="check" />
                                ...
                                <div class="table-responsive" style="padding-bottom:20px;" > 
                                    ...
                                    <table class="table table-striped table-hover table-bordered dataTable" id="printTable" style="width:100%;">
                                        ...
                                        <tbody id="">
                                            ...
                                            <tr ng-if='shipData != 0' ng-repeat="data in shipData">
                                                ...
                                                <td><a href="<?= base_url(); ?>stockInventory/stockhistory/{{data.sku}}/{{data.seller_id}}">{{data.sku}}</a></td>
                                                ...
                                                <td ng-if="!data.shelve_no" colspan="2">
                                                    ...
                                                    <br>
                                                    <a ng-click="GetupdatePallet_stock(PalletArray.pallet[$index], data.sid, data.id)" class="label label-info"><?= lang('lang_Update'); ?></a></td>
                                                ...
                                                <td class="Printshow">
                                                   ...
                                                   <li> 
                                                    <a  ng-if="data.quantity > 0" ng-click="GetUpdateDamageMissing(data);"><?= lang('lang_Update'); ?></a></li><li>
                                                    <a  ng-if="data.quantity == 0" ng-click="GetinventorydeleteUpdate(data.id);" ><i class="fa-solid fa-arrow-right-to-arc"></i>Unassign</a></li>
                                                   <li><a href="<?= base_url(); ?>/update_expire_new/{{data.id}}" ><i class="icon-pencil7"></i> <?= lang('lang_Update'); ?> <?= lang('lang_Expiry_Date'); ?></a></li>
                                    ...
                                    <button ng-hide="shipData.length == totalCount" class="btn btn-info" ng-click="loadMore_stock(count = count + 1, 0);" ng-init="count = 1"><?= lang('lang_Load_More'); ?></button>
                                </div>
                                <hr>
                            </div>
                        </div>
            ...
            <div class="modal fade" id="UpdateInventory" tabindex="-1" role="dialog" aria-labelledby="UpdateInventory" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form name="myform" novalidate ng-submit="myForm.$valid && GetupdateMissingInventory_stock()" enctype="multipart/form-data" >
                            <div class="modal-body">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal"><?= lang('lang_Close'); ?></button>
                                <button type="button" class="btn btn-primary" ng-if="updateArray.updateType && updateArray.upquantity <= updateArray.quantity" ng-click="GetupdateMissingInventory_stock();" ><?= lang('lang_Update'); ?></button>
                            </div>
                        </form>          
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">             
                                    <label class="container">
                                        ...
                                        <input type="checkbox" class="md-check" id='but_checkall' value='checkall' ng-model="checkall" ng-click='toggleAll()'/>     <?= lang('lang_SelectAll'); ?>
                                ...
                                <div class="col-md-12 row">
                                    <div class="col-sm-4">          
                                        <label class="container">  
                                            <input type="checkbox" class="md-check" name="name" value="name"   ng-model="listData2.name">  <?= lang('lang_Name'); ?>
                                            <span class="checkmark"></span>
                                        </label>   
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <label class="container">
                                            <input type="checkbox" class="md-check" name="item_type" value="item_type"  ng-model="listData2.item_type">  <?= lang('lang_Item_Type'); ?>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="col-sm-4">
                                        <label class="container">
                                            <input type="checkbox" class="md-check" name="storage_id" value="storage_id"  ng-model="listData2.storage_id">  <?= lang('lang_StorageType'); ?>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="col-sm-4">
                                        <label class="container">
                                            <input type="checkbox" class="md-check" name="sku" value="sku"  ng-model="listData2.sku">  <?= lang('lang_Item_SKU'); ?>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <label class="container">
                                            <input type="checkbox" class="md-check" name="stock_location" value="stock_location" ng-model="listData2.stock_location"> <?= lang('lang_Stock_Location'); ?>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <label class="container">
                                            <input type="checkbox" class="md-check" name="shelve_no" value="shelve_no" ng-model="listData2.shelve_no"> <?= lang('lang_Shelve_No'); ?>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="col-sm-4"> 
                                        <label class="container">
                                            <input type="checkbox" class="md-check" name="wh_name" value="wh_name" ng-model="listData2.wh_name"><?= lang('lang_warehouse'); ?>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="col-sm-4">
                                        <label class="container">
                                            <input type="checkbox" class="md-check" name="quantity" value="quantity"  ng-model="listData2.quantity"> <?= lang('lang_Quantity'); ?>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="col-sm-4">
                                        <label class="container">
                                            <input type="checkbox" class="md-check" name="seller_name" value="seller_name"  ng-model="listData2.seller_name">  <?= lang('lang_Seller'); ?>     
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <label class="container">
                                            <input type="checkbox" class="md-check" name="item_description" value="item_description"  ng-model="listData2.item_description"> <?= lang('lang_Description'); ?>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="col-sm-4">
                                        <label class="container">
                                            <input type="checkbox" class="md-check" name="update_date" value="update_date"  ng-model="listData2.update_date">  <?= lang('lang_Update_Date'); ?>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <label class="container">
                                            <input type="checkbox" class="md-check" name="expiry" value="expiry"  ng-model="listData2.expiry"><?= lang('lang_Expire_Status'); ?>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="col-sm-4">
                                        <label class="container">
                                            <input type="checkbox" class="md-check" name="expity_date" value="expity_date" ng-model="listData2.expity_date"> <?= lang('lang_Expire_Date'); ?>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                ...
                                <div class="row" style="padding-left: 40%;padding-top: 10px;">   
                                    ...
                                    <button type="submit" class="btn btn-info pull-left" name="shipment_transfer" ng-click="ItemInventoryExport_stock(listData2, listData1.exportlimit);"><?= lang('lang_Download_Excel_Report'); ?></button>  
                                </div>
