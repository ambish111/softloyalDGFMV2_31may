                ...
                <div class="content-wrapper" > 
                    ...
                    <div class="content" > 
                        ...
                        if (!empty($this->session->flashdata('messarray')['emptysku'])) {
                         ...
                         if (!empty($this->session->flashdata('messarray')['errorsku'])) {
                            echo '<div class="alert alert-warning">sku are invalid this row '. implode(',', $this->session->flashdata('messarray')['errorsku']) . '  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>';
                        }
                                                    ...
                                                    <ul class="icons-list">
                                                        <li class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <li><a  ng-if="data.quantity > 0" ng-click="GetUpdateDamageMissing(data);"><i class="icon-pencil7"></i> <?= lang('lang_Update'); ?></a></li>
                                                                
                                                                <li><a  ng-if="data.quantity == 0" ng-click="GetinventorydeleteUpdate(data.id);" ><i class="icon-trash"></i> Delete</a></li>
                                                                 <li><a href="<?= base_url(); ?>update_expire/{{data.id}}" ><i class="icon-pencil7"></i> <?= lang('lang_Update'); ?> <?= lang('lang_Expiry_Date'); ?></a></li>
