...
<html lang="en">
    <head>
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.3/js/select2.min.js"></script>
         <script src="<?= base_url(); ?>assets/js/angular/iteminventory.app.js?v=<?=time();?>"></script>
                    ...
                    <div class="content">
                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body">
                                ...
                                <form action="<?= base_url('ItemInventory/add'); ?>" id="myform" name="myform" onsubmit="document.getElementById('Newaddfrm').disabled=true; processFormData();" method="post">
 <input  type="hidden"  name='page_type' value='<?= $page_type; ?>'   class="form-control">
                                    ...
                                    <div class="form-group">
                                         ...
                                         <input id="tags" name="sku" ng-keyup="Getitemlist();" ng-focus="Getitemlist();" ng-blur="Getitemlist();" ng-keydown="Getitemlist();" ng-keypress="Getitemlist();" ng-model="filterData.search_sku" required  class="form-control" placeholder="Search SKU">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" class="btn btn-primary" id="Newaddfrm"   ><?=lang('lang_Confirm_Order');?></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
