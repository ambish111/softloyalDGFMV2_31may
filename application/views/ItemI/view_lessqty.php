...
<!-- Page container -->
<div class="page-container" ng-controller="Ctrlessqtyalertview" ng-init="loadMore(1,0);"> 
          ...
          <div class="col-lg-12" > 
            ...
            <div class="panel panel-flat" >
              <div class="panel-heading">
                <h1><strong><?=lang('lang_Less_Quantity');?></strong><!--<a href="<?= base_url('Excel_export/shipments');?>"></a> <a  ng-click="ExportExcelitemInventory();" ><i class="icon-file-excel pull-right" style="font-size: 35px; margin-top:3px;"></i></a>&nbsp;&nbsp; <a onclick="printPage('block1');" ><i class="fa fa-print pull-right" style="font-size: 40px;color:#999;"></i></a>--> </h1>
                  ...
                  <table class="table table-bordered table-hover" style="width: 100%;">
                    ...
                    <tbody >
                      <tr style="width: 80%;">
                        ...
                        <input type="hidden" ng-model="filterData.pagetype">
              ...
              <table class="table table-striped table-hover table-bordered dataTable bg-*" id="printTable" style="width:100%;">
                <thead>
                  <tr>
                    ...
                    <th><?=lang('lang_Stock_Quantity');?></th>
                ...
                <tbody id="">
                  ...
                  <tr ng-if='shipData!=0' ng-repeat="data in shipData">
                    ...
                    <td ng-if="data.checkreQty=='Y'"><span class="badge badge-danger">{{data.quantity}}</span></td>
                    <td ng-if="data.checkreQty=='N'"><span class="badge badge-danger">{{data.quantity}}</span></td>
                     <td><span class="badge badge-warning">{{data.less_qty}}</span></td>
