                    ...
                    <div class="content" >
                        ...
                        <div class="panel panel-flat"  >
                            ...
                            <div class="panel-heading" dir="ltr">
                                ...
                                <h1><strong><?= lang('lang_Offers_List'); ?></strong>   <a id="btnExport" ><i class="icon-file-excel pull-right" style="font-size: 35px;"></i></a></h1>
...
<?php endforeach; ?>
                                    ...
                                    <table class="table table-striped table-hover table-bordered dataTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th align="center"><?= lang('lang_Main_Item'); ?><table class="table table-striped table-hover table-bordered dataTable "><tr><th><?= lang('lang_SKU'); ?></th><th><?= lang('lang_QTY'); ?></th></tr></table></th>
                    ...
                    <!-- <th>Category</th> -->
                                                    ...
                                                    <ul class="icons-list">
                                                        <li class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-right">
                                                                <li><a href="<?= site_url(); ?>Offers/edit_offer/{{data.id}}"><i class="icon-pencil7"></i> <?= lang('lang_Edit'); ?> </a></li>
                                ...
                                <div style="display: none;">
                                    ...
                                    <table class="table table-striped table-hover table-bordered dataTable" id="downloadtable">
                                        <thead>
                                            <tr>
                                                <th><?= lang('lang_SrNo'); ?>.</th>
                                                <th><?= lang('lang_Promo_Code'); ?></th>
            ...
            var uri = 'data:application/vnd.ms-excel;base64,', template = '<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns="http://www.w3.org/TR/REC-html40"><head><!--[if gte mso 9]><xml><x:ExcelWorkbook><x:ExcelWorksheets><x:ExcelWorksheet><x:Name>{worksheet}</x:Name><x:WorksheetOptions><x:DisplayGridlines/></x:WorksheetOptions></x:ExcelWorksheet></x:ExcelWorksheets></x:ExcelWorkbook></xml><![endif]--><meta http-equiv="content-type" content="text/plain; charset=UTF-8"/></head><body><table>{table}</table></body></html>'
                        ...
                        return blobURL;
                          ...
                          $("#btnExport").click(function  ()  {
                              var      todaysDate='Bundel-Offers List ' + new Date();
                              var blobURL = tableToExcel('downloadtable', 'Bundel Offers');
