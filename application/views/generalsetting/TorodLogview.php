...
<html lang="en">
    ...
    <body ng-app="log" >
        ...
        <!-- Page container -->
        <div class="page-container" ng-controller="shipment_log_view" ng-init="TorodloadMore(1, 0);" >
                            ...
                            <div class="col-lg-12" >
                                ...
                                <div class="panel panel-flat">
                                    <div class="panel-heading" dir="ltr">
                                        <h1>
                                            <strong><?//=lang('lang_Forward_Log');?> Torod Warehouse Log</strong>
...
<!-- <a id="pdf" ><i class="icon-file-pdf pull-right" style="font-size: 35px;color: red;"></i></a>-->
                                        ...
                                        <div class="panel-body" >
                                            <div class="col-lg-12" style="padding-left: 20px;padding-right: 20px;">
                                                ...
                                                <div class="col-md-3">  <div class="form-group" ><strong><?=lang('lang_Status');?>:</strong>
                                                        ...
                                                        <option value="Failed"><?=lang('lang_Fail');?></option>     
                                                ...
                                                <!-- <div class="col-md-3"> 
                                                    <div class="form-group" ><strong><?=lang('lang_company');?>:</strong>
                                                        <br>
                                                        <?php
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form-group" >
                                                        <button  class="btn btn-danger" ng-click="TorodloadMore(1, 1);" ><?=lang('lang_Search');?></button>
                                ...
                                <div class="table-responsive" style="padding-bottom:20px;" >
                                    ...
                                    <table class="table table-striped table-hover table-bordered dataTable" id="example" style="width:100%;">
                                        ...
                                        <tr ng-if='shipData != 0' ng-repeat="data in shipData"> 
                                            ...
                                            <td>{{data.log}}</td>
                                            <td><span class="req_data_{{$index + 1}}">{{data.request}}</span>
                                                <span ng-if="data.request != NULL" id="{{$index + 1}}" class="btn btn-success btn-sm" onclick="copyText(this);" >Copy Text</span>
                                            </td>
                                        </tr>
                                    </table>
                                    <button ng-hide="shipData.length == totalCount" class="btn btn-info" ng-click="TorodloadMore(count = count + 1, 0);" ng-init="count = 1"><?=lang('lang_Load_More');?></button>
                                </div>
                                <hr>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        function copyText(obj){ 
            ...
            var copyText =    $(".req_data_"+currentID).html() ;//document.getElementById("request_"+currentID);
