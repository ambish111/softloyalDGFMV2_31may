                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Additional Weight Rate</th>   
                                                  <th>Return Max Weight Range</th>   
                                                <th>Return Max Weight Range Rate</th> 
                                                <th>Return Additional Weight Rate</th>   
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $seller->max_weight; ?></td> 
                                                         <td><?= $seller->flat_price; ?></td> 
                                                          <td><?= $seller->price; ?></td> 
                                                           <td><?= $seller->r_max_weight; ?></td> 
                                                         <td><?= $seller->r_flat_price; ?></td> 
                                                          <td><?= $seller->r_price; ?></td> 
                                                            ...
                                                            <ul class="icons-list">
                                                                <li class="dropdown">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                                        <li><a href="<?= base_url(); ?>editZoneclient/<?= $seller->id; ?>"><i class="icon-pencil7"></i>  <?= lang('lang_Edit'); ?></a></li>
