                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body">
                                ...
                                ?>
                                    ...
                                    <form action="<?= base_url('Zones/add_zone_customer'); ?>" method="post"  name="add_customer" enctype="multipart/form-data">
                                        <?php } else { ?>
                                        <form action="<?= base_url('Zones/editZoneUpdateCustomer/' . $id); ?>" method="post"  name="add_customer" enctype="multipart/form-data">
<?php } ?>
                                        ...
                                        <fieldset class="scheduler-border">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="company" name="name" value="<?php if (!empty($EditData))
...
<?php } ?>
                                            ...
                                            <div class="form-group ">
                                                <label>Return <?= lang('lang_Max_Weight_Range'); ?></label>
                                                <span id="r_max_weight"></span>
                                                <input type="number" name="r_max_weight" class="form-control" value="<?= $EditData[0]->r_max_weight; ?>" required>
                                            </div>

                                            <div class="form-group ">
                                                <label>Return <?= lang('lang_Max_Weight_Range_Rate'); ?></label>
                                                <span id="r_flat_price"></span>
                                                <input type="number" name="r_flat_price" class="form-control" value="<?= $EditData[0]->r_flat_price; ?>" required>
                                            </div>
                                            <div class="form-group ">
                                                <label>Return <?= lang('lang_Additional_Weight_Rate'); ?></label>
                                                <span id="r_price"></span>
                                                <input type="number" name="r_price" class="form-control" value="<?= $EditData[0]->r_price; ?>" required>
                                            </div>
...
<Script>
    ...
    $("#courier_id").change(function () {
        ...
        $.ajax({
            url: '<?php echo base_url('Zones/filter_zone_by_cc'); ?>',
            method: "POST",
            data: {cc_id: cc_id},
            dataType: "html",
            beforeSend: function () {
