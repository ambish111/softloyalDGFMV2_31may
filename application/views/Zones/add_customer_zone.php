                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body">
                                ...
                                <?php if ($this->session->flashdata('err_msg') != '') {
                                    ...
                                    <form action="<?= base_url('Zone/add_zone_customer'); ?>" method="post"  name="add_customer" enctype="multipart/form-data">
                                        <?php } else { ?>
                                        <form action="<?= base_url('Zone/editZoneUpdateCustomer/' . $id); ?>" method="post"  name="add_customer" enctype="multipart/form-data">
<?php } ?>
