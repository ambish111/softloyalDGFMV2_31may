...
<body ng-app="AppTickets" ng-controller="CTR_ticketlist" >
	...
	<div class="row">
                ...
                <div class="panel-footer">
                    <div class="input-group">
                        <input id="btn-input" type="text" class="form-control input-sm chat_input" id="replymess" name="replymess" ng-model="historyData.replymess"  placeholder="Write your message here..." />
