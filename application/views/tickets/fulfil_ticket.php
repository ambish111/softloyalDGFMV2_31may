...
<!-- Page container -->
<div class="page-container" ng-controller="CTR_ticketlist_fulfil" ng-init="loadMore(1,0);">
    ...
    <div class="table-responsive" style="padding-bottom:20px;" > 
      ...
      <table class="table table-striped table-hover table-bordered dataTable bg-*" id="example" style="width:100%;">
        ...
        <tr ng-if='shipData!=0' ng-repeat="data in shipData">
          ...
          <td ><a href="<?=base_url();?>Ticket/tickethistory/{{data.ticket_id}}" >{{data.awb_no}}</a></td>
       ...
       <!--   <td width="200"  ng-if="data.status=='process'"><span class="badge badge-warning">Process</span></td>
          <td width="200"  ng-if="data.status=='complated'"><span class="badge badge-success" >completed</span></td>-->
