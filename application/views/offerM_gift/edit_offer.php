                            ...
                            <div class="panel-body">
                                ...
                                <form action="<?= base_url('Offers/getaddform'); ?>" method="post" name="itmfrm" >
                                    ...
                                    <div class="form-group">
                                        <label for="gift_item"><strong>Type :</strong></label><br>
                                 
                                          
                                        <input type="radio" ng-model="fromdata.gift_type"  value="PI">   Per Item &nbsp;&nbsp;&nbsp;
                                            <input type="radio" ng-model="fromdata.gift_type"  checked="" value="PO">  Per Order          
                                            ...
                                            app.controller('formCtrl', function ($scope, $http, $interval, $window) {
                                                ...
                                                $scope.qtyfiled = {};
                                                 ...
                                                 $scope.fromdata.gift_item = <?=$offer_itemsArr;?>;
                                                  ...
                                                  $scope.fromdata.type_new='<?=$editData['gift_type'];?>';
                                                  ...
                                                  $scope.fromdata.gift_type=$scope.fromdata.type_new;
