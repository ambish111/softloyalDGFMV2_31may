...
<div class="panel-heading">
  <h1> <strong>Pickup Charges</strong> <a  id="btnExport" ><i class="icon-file-excel pull-right" style="font-size: 35px; margin-top:3px;"></i></a>&nbsp;&nbsp; <a onclick="printPage();" ><i class="fa fa-print pull-right" style="font-size: 40px;color:#999;"></i></a> </h1>
</div>
    ...
    <table class="table table-bordered table-hover" style="width: 100%;">
      ...
      <tbody >
        <tr style="width: 80%;">
          ...
          <td><button  class="btn btn-danger" ng-click="Pickupchargesdata(1,0);" >Get Details</button></td>
        </tr>
      </tbody>
    </table>
    <br>
      ...
      <table class="table table-striped table-hover table-bordered dataTable bg-*" id="printTable" style="width:100%;">
        <thead>
          <tr>
            ...
            <!-- <th>SKU</th>
            <th>QTY</th>-->
            <th align="center" style="text-align:center;">Storage Details
        ...
        <tr ng-if='showlistData!=0' ng-repeat="data in showlistData">
          ...
          <!--  <td>{{data.sku}}</td>
          <td>{{data.qty}}</td>-->
          <td><table class="table table-striped table-hover table-bordered dataTable bg-*" ng-repeat="data2 in data.storageArray">
              <tr>
                <td >{{data2.storagetypename}}</td>
                <td>{{data2.totalpallets | number:2}}</td>
                <td>{{data2.totalstorage}}</td>
              </tr>
            </table></td>
