              ...
              <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-menu9"></i> </a>
                <ul class="dropdown-menu dropdown-menu-right">
                  ...
                  <li ><a  href="<?=base_url();?>viewinvoice/{{data.invoice_no}}" target="_blank"><i class="icon-eye" ></i>   <?=lang('lang_View_Invoice');?></a></li>
                   <li ><a  href="<?=base_url();?>viewinvoice_new/{{data.invoice_no}}" target="_blank"><i class="icon-eye" ></i>   <?=lang('lang_View_Invoice');?></a></li>
                  <li ><a  href="<?=base_url();?>Bulkdownload_in/export/{{data.invoice_no}}" target="_blank"><i class="icon-eye" ></i>   Download </a></li>
                   <li ><a  href="<?=base_url();?>Bulkdownload_in/export_new/{{data.invoice_no}}" target="_blank"><i class="icon-eye" ></i>   Download New</a></li>
                  <li>
