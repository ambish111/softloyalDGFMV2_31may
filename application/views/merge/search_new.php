...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="<?= base_url(); ?>assets/js/angular/merge_new.app.js?token=<?= time(); ?>"></script>

         <style>
            
            .select2-container--default .select2-selection--single .select2-selection__rendered { line-height: 13px !important;}
        </style>
    </head>
