                ...
                <div class="content-wrapper">
                    ...
                    <div class="content">
                        <div class="panel panel-flat">
                            <div class="panel-heading"><h1><strong>Edit Mapping</strong><button  class="btn btn-danger" ng-click="viewAlMapping();"   style="margin-left:7%;float:right;">View All Mapping</button></h1>
                            ...
                            <div class="col-md-12" ng-if="responseError">
                                ...
                                <form action="<?= base_url(); ?>update_mapping" name="edit_mapping" method="POST">
                                    <div class="form-group">
                                        <strong><?=lang('lang_company');?>:</strong>
                                        <select  id="cc_id" name="cc_id"  data-live-search="true" class="selectpicker" data-width="100%" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="map_data" name="map_data"   rows="15" class="form-control" sytle="border:1px solid;" ><?=$mapdata['map_data'] ?></textarea>
