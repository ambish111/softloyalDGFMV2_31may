...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="<?= base_url(); ?>assets/js/angular/ordergen.app.js?v=<?=time();?>"></script>
    </head>
                            ...
                            <div class="col-lg-12" >
                                ...
                                <div class="panel panel-flat">
                                    <div class="panel-heading" dir="ltr">
                                        <h1> <strong><?=lang('lang_OrderGenerated');?></strong> <a  ng-click="exportExcel('#downloadtable');" ><i class="icon-file-excel pull-right" style="font-size: 35px;"></i></a>
                         ...
                         <option ng-repeat="cData in citylist"  data-select-watcher data-last="{{$last}}" value="{{cData.id}}" >{{cData.city}}</option>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-md-2"><div class="form-group" ><strong>Limit:</strong>
                                                         ...
                                                         <div class="col-md-2">
                                                            <div class="form-group" ><strong>On Hold:</strong>
...
<!-- <th>Cartoon Quantity</th> -->
                                                ...
                                                <td colspan="2" align="center"><?=lang('lang_Action');?> </td>
                                            </tr>
                                        </thead>
                                        
                                        <tr ng-if='shipData != 0' ng-repeat="data in shipData">
                                            <td>{{$index + 1}} 
                                                <input type="checkbox" ng-if="data.reciever_name != '' && data.reciever_phone != '' && data.origin_valid != 0 && data.destination_valid != 0 && data.on_hold != 'Yes'" value="{{data.slip_no}}" check-list='Items' ng-model="data.Selected" ng-click="checkIfAllSelected()" />
                                                <input type="checkbox" ng-if="data.reciever_name == '' || data.reciever_phone == '' || data.origin_valid == 0 || data.destination_valid == 0 || data.on_hold == 'Yes'" disabled  /></td>
                                                    ...
                                                    <tbody>
                                                        <tr ng-repeat="data1 in data.skuData">
                                                            <td ><span class="label label-primary">{{data1.sku}}</span></td>
                                                             <?php if (menuIdExitsInPrivilageArray(230) == 'Y') { ?>
                                                             <td ><span class="label label-primary">{{data1.ean_no}}</span></td>
                                                             <?php } ?>
                                ...
                                <tbody>
                                  <tr ng-repeat="data2 in data.expire_details">
                                    ...
                                    <td><span class="label label-danger">{{data2.expity_date}}</span></td>
                                            ...
                                            <td><?php if (menuIdExitsInPrivilageArray(122) == 'Y') { ?><a class="btn btn-danger" ng-click="GetcheckOrderDeleteStatus(data.slip_no);" ng-confirm-click="Are You Sure Want To Delete Order?"><?=lang('lang_Delete');?></a>  <?php } ?></td>
                                            
                                              <?php if (menuIdExitsInPrivilageArray(123) == 'Y') { ?>
                                            <td><a class="btn btn-info" ng-click="GetEditshipemtPopProcee($index);" ng-confirm-click="Are You Sure Want To Edit Order?"><?=lang('lang_Edit');?></a></td> <?php } ?>
                                        </tr>
                                    </table>
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td style="border: none;" ><div class="form-group" ><strong>Postal Code:</strong>
                                                          ...
                                                          <td style="border: none;" ><div class="form-group" ><strong><?= lang('lang_Total_COD_Amount'); ?> :</strong>
                                                                                         <input string-to-number type="number" min="0" step="any" class="form-control" name="total_cod_amt" ng-model="ShipmentEditArr.total_cod_amt"  id="total_cod_amt">
