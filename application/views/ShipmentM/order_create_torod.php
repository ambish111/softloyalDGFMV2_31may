                            ...
                            <div class="col-lg-12" > 
                                ...
                                <div class="panel panel-flat">
                                    <div class="panel-heading">
                                        <h1> <strong><?//=lang('lang_Forward_to_Delivery_Station');?>Order Create on Torod</strong> </h1>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">  
                                                    <div class="form-group">
                                                        ...
                                                        <select  class="select2  form-control" ng-model="userselected.cc_id" style="word-wrap: break-word; width:100% !important"   data-placeholder="Choose Company" required="">
                                                            ...
                                                            <option ng-repeat="d_data in DeliveryDropArr" ng-if="d_data.company == 'Torod'" value="{{d_data.cc_id}}">{{d_data.company}}</option>
                                                        </select>  
                                                    </div>
                                                </div>
                                                <div class="col-md-3">  
                                                ...
                                                <div class="col-md-2" style="margin-bottom: 11px;">   
                                                    <label>&nbsp;</label>
                                                    <button type="submit" class="btn btn-primary form-control" ng-click="BulkForwardCompany();"><?=lang('lang_Submit');?> </button>
                                                </div>
                                            </div>
