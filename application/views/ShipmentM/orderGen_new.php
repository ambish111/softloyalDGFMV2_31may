...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="<?= base_url(); ?>assets/js/angular/ordergen_new.app.js?v=<?=time();?>"></script>
    </head>
                     ...
                     <option ng-repeat="cData in citylist"  data-select-watcher data-last="{{$last}}" value="{{cData.id}}" >{{cData.city}}</option>
                                                ...
                                                <div class="col-md-2"><div class="form-group" ><strong>Limit:</strong>
                                                    ...
                                                    <div class="col-lg-12" style="padding-left: 0px;padding-right: 20px;"> <div class="form-group" > <button  class="btn btn-danger ml-10" ng-click="loadMore(1, 1);" ><?=lang('lang_Search');?></button>
                                                        ...
                                                        <button type="button" class="btn btn-danger ml-10">Selected  <span class="badge">{{Items.length}}</span></button>
                                                    </div>
                                                </div>
                        ...
                        <div class="panel panel-flat" >
                            <div class="panel-body" >
                                <div class="alert alert-warning">Note : Order Create Max limit is 200. <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>
