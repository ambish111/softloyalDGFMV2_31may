...
<script type="text/javascript" src="<?= base_url('assets/js/angular/app.js'); ?>?v=<?=time();?>"></script>
<script type="text/javascript" src="<?= base_url('assets/js/angular/shelve.app.js'); ?>?v=<?=time();?>"></script>
<script type="text/javascript" src="<?= base_url('assets/js/angular/templatesCtrl.js'); ?>?v=<?=time();?>"></script>
