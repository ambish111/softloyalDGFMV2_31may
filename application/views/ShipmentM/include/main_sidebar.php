        ...
        <div class="sidebar-category sidebar-category-visible">
            <div class="category-content no-padding">
                    ...
                    <?php if (menuIdExitsInPrivilageArray(1) == 'Y') { ?>
                        <li <?php if ($this->uri->segment(1) == 'Shipment' || $this->uri->segment(1) == 'bulk_update_view' || $this->uri->segment(1) == 'TrackingResult' || $this->uri->segment(1) == 'TrackingDetails' || $this->uri->segment(1) == 'Forward_Delivery_Station' || $this->uri->segment(1) == 'bulkprint' || $this->uri->segment(1) == 'forwardshipments' || $this->uri->segment(1) == 'forwardedshipments' || $this->uri->segment(1) == 'bulk_tracking' || $this->uri->segment(1) == 'Backorder' || $this->uri->segment(1) == 'OpenShipment' || $this->uri->segment(1) == 'cod_update_3pl') echo 'class="active"'; ?>> <a href="#"><i class="icon-bus"></i> <span><?= lang('lang_Shipment_Management'); ?></span></a>
                            ...
                            <!-- <li><a href="<?= base_url('Forward_Delivery_Station'); ?>"><?= lang('lang_Bulk_Forward3PL'); ?></a></li> -->
                                <?php //} ?>
                                <?php if (menuIdExitsInPrivilageArray(81) == 'Y') { ?>
                                    <li><a href="<?= base_url('Forward_Delivery_Station_New'); ?>"><?= lang('lang_Bulk_Forward3PLnew'); ?></a></li>
                                <?php } ?>
                                ...
                                <?php if (menuIdExitsInPrivilageArray(157) == 'Y') { ?>
                                    <li><a href="<?= base_url('bulk-audit'); ?>">Bulk Audit</a></li>
                                <?php } ?>

                                <?php if (menuIdExitsInPrivilageArray(160) == 'Y' && $this->system_type == 'new') { ?>
                                    <li><a href="<?= base_url('bulk_order_create'); ?>">Bulk Order Create</a></li>
                                <?php } ?>
                                <?php if (menuIdExitsInPrivilageArray(161) == 'Y') { ?>
                                    <li><a href="<?= base_url('cod_update_3pl'); ?>">Bulk 3PL Cod</a></li>
                                <?php } ?>
                                ...
                                <?php if (menuIdExitsInPrivilageArray(159) == 'Y') { ?>
                                    <li><a href="<?= base_url('bulkUploadShipment'); ?>">Bulk Update Shipment</a></li>
                                <?php } ?>
                            </ul>
                        </li>
                    <?php } ?>
                    ...
                    <?php if (menuIdExitsInPrivilageArray(2) == 'Y') { ?>
                        <li <?php if ($this->uri->segment(1) == 'ItemInventory' || $this->uri->segment(1) == 'add_shelve' || $this->uri->segment(1) == 'view_shelve' || $this->uri->segment(1) == 'shelve_sku' || $this->uri->segment(1) == 'historyview' || $this->uri->segment(1) == 'skuTransfer' || $this->uri->segment(1) == 'skuTransferedList' || $this->uri->segment(1) == 'inventory_check') echo 'class="active"'; ?>> <a href="#"><i class="icon-copy"></i> <span><?= lang('lang_Inventory_Management'); ?></span></a>
                            <ul>
                                ...
                                <?php if (menuIdExitsInPrivilageArray(31) == 'Y' && $this->system_type == 'old') { ?>
                                    <li><a href="<?= base_url('ItemInventory/add_view'); ?>"> <?= lang('lang_Add_Item_Inventory'); ?></a></li>
                                <?php } ?>

                                <?php if (menuIdExitsInPrivilageArray(33) == 'Y' && $this->system_type == 'old') { ?>
                                    <li><a href="<?= base_url('ItemInventory'); ?>"><?= lang('lang_View_Item_Inventory'); ?></a></li>
                                <?php } ?>
                                <?php if (menuIdExitsInPrivilageArray(33) == 'Y' && $this->system_type == 'new') { ?>
                ...
                <li><a href="<?= base_url('skuTransferedList'); ?>">Stock Tranfer List</a></li>-->
                                <?php } ?>
                                <?php if (menuIdExitsInPrivilageArray(150) == 'Y' && $this->system_type == 'old') { ?>
                                    <li><a href="<?= base_url('Mergestock'); ?>">Merge Stock</a></li>
                                <?php } ?>
                                <?php if (menuIdExitsInPrivilageArray(150) == 'Y' && $this->system_type == 'new') { ?>
                                    <li><a href="<?= base_url('Mergestock_new'); ?>">Merge Stock</a></li>
                                <?php } ?>

                                <?php if (menuIdExitsInPrivilageArray(119) == 'Y' && $this->system_type == 'old') { ?>
                                    <li><a href="<?= base_url('inventory_check'); ?>"><?= lang('lang_Inventory_Per_Client'); ?></a></li>
                                <?php } ?>
                                <?php if (menuIdExitsInPrivilageArray(119) == 'Y' && $this->system_type == 'new') { ?>
                                    <li><a href="<?= base_url('inventory_check_new'); ?>"><?= lang('lang_Inventory_Per_Client'); ?></a></li>
                                <?php } ?>

                                <?php if (menuIdExitsInPrivilageArray(40) == 'Y' && $this->system_type == 'old') { ?>
                                    <li class="navigation-divider"></li>
                    ...
                    <?php if (menuIdExitsInPrivilageArray(2) == 'Y') { ?>
                        <li <?php if ($this->uri->segment(2) == 'AddofferGift' || $this->uri->segment(2) == 'giftOffersList' || $this->uri->segment(1) == 'generateStockLocation' || $this->uri->segment(1) == 'showStock' || $this->uri->segment(2) == 'giftOffersList' || $this->uri->segment(2) == 'edit_offer_gift') echo 'class="active"'; ?>> <a href="#"><i class="icon-gift"></i> <span> <?= lang('lang_Stock_Location_management'); ?> </span></a>
                            <ul>
                                ...
                                <?php if (menuIdExitsInPrivilageArray(37) == 'Y' && $this->system_type == 'old') { ?>
                                    <li><a href="<?= base_url('generateStockLocation'); ?>"><?= lang('lang_Generate_Stock_Location'); ?></a></li>
                                <?php } ?>

                                <?php if (menuIdExitsInPrivilageArray(37) == 'Y' && $this->system_type == 'new') { ?>
                                ...
                                <?php if (menuIdExitsInPrivilageArray(38) == 'Y' && $this->system_type == 'old') { ?>
                                    <li><a href="<?= base_url('showStock'); ?>"> <?= lang('lang_All_Stock_Location'); ?></a></li>
                                <?php } ?>
                                <?php if (menuIdExitsInPrivilageArray(38) == 'Y' && $this->system_type == 'new') { ?>
...
<?php if (menuIdExitsInPrivilageArray(17) == 'Y') { ?>
                        <li <?php if ($this->uri->segment(1) == 'shownewmanifestRequest' || $this->uri->segment(1) == 'showpickuplist' || $this->uri->segment(1) == 'showmenifest' || $this->uri->segment(1) == 'manifestview' || $this->uri->segment(1) == 'showTicket' || $this->uri->segment(1) == 'show_assignedlist') echo 'class="active"'; ?>> <a href="#"><i class="icon-stack2"></i> <span><?= lang('lang_Manifest_Management'); ?></span></a>
                            <ul>
                                ...
                                <?php if (menuIdExitsInPrivilageArray(51) == 'Y' && $this->system_type == 'old') { ?>
                                    <li><a href="<?= base_url('show_assignedlist'); ?>"><?= lang('lang_Show_Assigned_List'); ?></a></li>
                                <?php } ?>
                                <?php if (menuIdExitsInPrivilageArray(51) == 'Y' && $this->system_type == 'new') { ?>
...
<?php if (menuIdExitsInPrivilageArray(19) == 'Y') { ?>
                        <li <?php if ($this->uri->segment(2) == 'offerslist' || $this->uri->segment(2) == 'OfferOrders' || $this->uri->segment(2) == 'Addoffers' || $this->uri->segment(1) == 'OfferOrders' || $this->uri->segment(1) == 'OfferOrders_gift') echo 'class="active"'; ?>> <a href="#"><i class="icon-gift"></i> <span> <?= lang('lang_Offer_Management'); ?> </span></a>
                            <ul>
                        ...
                        <li <?php if ($this->uri->segment(2) == 'AddofferGift' || $this->uri->segment(2) == 'giftOffersList' || $this->uri->segment(2) == 'giftOffersList' || $this->uri->segment(2) == 'edit_offer_gift' || $this->uri->segment(2) == 'packing_b2b') echo 'class="active"'; ?>> <a href="#"><i class="icon-gift"></i> <span> <?= lang('lang_Packaging_Management'); ?> </span></a>
                            <ul>
                                ...
                                <?php if (menuIdExitsInPrivilageArray(162) == 'Y') { ?>
                                    <li <?php if ($this->uri->segment(1) == 'PackStatus') echo 'class="active"'; ?>> <a href="<?= base_url('PackStatus'); ?>"></i> <span>Pack Force</span></a> </li>
                                <?php } ?>
                                <?php if (menuIdExitsInPrivilageArray(9) == 'Y' && $this->system_type == 'old') { ?>
                                    <li <?php if ($this->uri->segment(1) == 'packing') echo 'class="active"'; ?>> <a href="<?= base_url('packing'); ?>"></i> <span><?= lang('lang_Packaging'); ?></span></a> </li>
                                <?php } ?>
                                     <?php if (menuIdExitsInPrivilageArray(9) == 'Y' && $this->system_type == 'new') { ?>
...
?>
                    ...
                    <?php if (menuIdExitsInPrivilageArray(78) == 'Y' && $this->system_type == 'old') { ?>
                    ...
                    <?php } ?>
                         <?php if (menuIdExitsInPrivilageArray(78) == 'Y' && $this->system_type == 'new') { ?>
...
<?php if (menuIdExitsInPrivilageArray(149) == 'Y' && $this->system_type == 'old') { ?>
...
<?php if (menuIdExitsInPrivilageArray(109) == 'Y') { ?>
                        <li  <?php if ($this->uri->segment(1) == 'shelve_report' || $this->uri->segment(1) == 'topdispatchproduct' || $this->uri->segment(1) == 'performance' || $this->uri->segment(1) == 'client_report' || $this->uri->segment(1) == 'dispatching_report' || $this->uri->segment(1) == 'InboundRecord' || $this->uri->segment(1) == 'report_3pl' || $this->uri->segment(1) == 'view_damage_inventory' || $this->uri->segment(1) == 'delivered' || $this->uri->segment(1) == 'returned') echo 'class="active"'; ?>>
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                ...
                                <?php if (menuIdExitsInPrivilageArray(113) == 'Y' && $this->system_type == 'old') { ?>

                                    <li><a href="<?= base_url('shelve_report'); ?>"><?= lang('lang_Shelve_Report'); ?></a></li>
                                <?php } ?>
                                    <?php if (menuIdExitsInPrivilageArray(113) == 'Y' && $this->system_type == 'new') { ?>
                                ...
                                <?php if (menuIdExitsInPrivilageArray(83) == 'Y' && $this->system_type == 'old') { ?>
    ...
    <?php } ?>
                                ...
                                <?php } ?>
                                <?php if (menuIdExitsInPrivilageArray(76) == 'Y' && $this->system_type == 'old') { ?>
                                ...
                                <?php } ?>
                                     <?php if (menuIdExitsInPrivilageArray(76) == 'Y' && $this->system_type == 'new') { ?>
                                ...
                                <li><a href="<?= base_url(); ?>stockInventory/stockhistory" >Seller Stock History</a></li>
                                    ...
                                    <li><a href="<?= base_url('damage_inventory_history'); ?>">Damage <?= lang('lang_Inventory_History'); ?></a></li>
                                <?php } ?>
    ...
    <?php if (menuIdExitsInPrivilageArray(105) == 'Y') { ?>
                        ...
                        <?php } ?>
                                <li> <a   href="<?= base_url(); ?>courierHealthReport" >3PL courier Company Reports</a> </li>                           
...
<?php if (menuIdExitsInPrivilageArray(151) == 'Y' && $this->system_type == 'old') { ?>
                    ...
                    <?php } ?>
                        ...
                        <li> <a type="button"  href="<?= base_url(); ?>Backorder_new" class="btn btn-danger" style=" margin-left: 2%; margin-right: 3%; ">BackOrder <span class="badge"><?php echo statusCount_back(); ?></span></a> </li>
                    <?php } ?>
                    ...
                    <?php } ?>
                        ...
                        <li > <a type="button" href="<?= base_url(); ?>Shipment_og/ordergeneratedView" class="btn btn-warning" style="margin-left: 2%; margin-right: 3%"><?= lang('lang_OrderGenerated'); ?> <span class="badge"><?php echo statusCount(11); ?></span></a> </li>
