                                ...
                                <div class="panel panel-flat">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form  method="post" action="<?= base_url(); ?>Shipment/bulkauditupdate"  >
                                            ...
                                            <input type="submit" name="track_ready" class="btn btn-primary form-control checkdisable" value="Update">	
