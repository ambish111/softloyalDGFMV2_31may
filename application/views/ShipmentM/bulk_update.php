...
<html lang="en">
    ...
    <body ng-app="fulfill" ng-controller="bulkUpdate"  >
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-lg-12" >
                                                ...
                                                <div  ng-if="invalidstring" style="word-wrap: break-word;" ><div class="alert alert-danger"><?=lang('lang_Not_avaible_selected_Update_Orders_removed_automatically');?>:{{invalidstring}}</div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <select  id="status" name="status" ng-model="scan.status" ng-change="scan_awb();" class="selectpicker"  data-width="100%" >
                                                        ...
                                                        <?php endforeach; ?>
                                                            <?php if (menuIdExitsInPrivilageArray(158) == 'Y') { ?>
                                                            <option value="8">Return</option>
                                                            <?php } ?>
                                                             <?php if (menuIdExitsInPrivilageArray(231) == 'Y') { ?>
                                                            <option value="40">Lost/Damage</option>
