...
<html lang="en">
    <head>
        ...
        <script src="<?= base_url(); ?>assets/js/angular/bulk_create_new.js?v=<?= time(); ?>"></script>
        <style>
                                ...
                                <div class="panel panel-flat">
                                    ...
                                    <div class="panel-body">
                                        <div class="clearfix">
                                            ...
                                            <br>
                                            <span class="badge badge badge-pill badge-danger mt-10" id="count_val">You can order Create 200 shipments.
                                            </span> 
                                        </div>
                                        <br>
                                        <div class="row">
                                            ...
                                            <div class="col-md-12" ng-if="errordata_stock.length != 0">
                                                <div class="alert alert-danger"  ng-repeat="es_data in errordata_stock">
                                                    ...
                                                    <p ng-if="es_data.error_type == 'warehouse_diffrent'">this sku {{es_data.sku}} Different Warehouse{{es_data.slip_no}}</p>
