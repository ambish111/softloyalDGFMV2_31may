            ...
            <div class="content-wrapper">
                ...
                <div class="content">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading" dir="ltr"><h1><strong><?=lang('lang_Bulk_Upload');?></strong><a href="<?= base_url('Excel_export/shipment_bulk_format');?>"><i class="icon-file-excel pull-right" style="font-size: 35px;"></i></a></h1></div>
                        <div class="alert alert-danger"><strong><?=lang('lang_Note');?> </strong><br>&nbsp1.  To add bulk of Shipment use this import feature. Below are the columns you must have according to serial number in the excel csv file. All fields are required. Click above excel icon to get excel file for an idea.<br>&nbsp2. <?=lang('lang_All_fields_are_required');?>.<br>&nbsp3. <?=lang('lang_Click_above_excel_icon_excel_file_idea');?>.</div>
                        <hr> 
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>(2) 3pl AWB Number  <span style="color:#F00"><strong>*</strong></span></td>
                        <td>(3) Forwarded Date  <span style="color:#F00"><strong>*</strong></span></td>
                        <td>(4) 3pl Label Link <span style="color:#F00"><strong>*</strong></span></td>
                ...
                <br>
                <form class="stdform" method="post" action="<?= base_url('Excel_export/shipmentsBulkStore');?>" id="AddnventoryID" name="AddnventoryID" enctype="multipart/form-data" onsubmit="document.getElementById('Newaddfrm').disabled=true; processFormData();">
