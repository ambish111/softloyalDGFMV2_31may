...
<!-- href="<? //base_url('Pdf_export/all_report_view');  ?>" --> 
                                    ...
                                    <table class="table table-striped table-hover table-bordered"  style="width:100%;">
                                        <thead>
                                            <?php
                                             ...
                                             $lang_Payment_Mode=lang('lang_Payment_Mode');		
                                             $lang_Transaction_Date=lang('lang_Transaction')." ".lang('lang_Day');	
              ...
              ';
                                    ...
                                    //foreach ($skuArr as $key => $skuval) {
                                        ...
                                        $counter2 = $key + 1;
                                        $sku_main_arr = getalldataitemtablesSKU_single($skuval['sku']);
                                        
                                        if ($sku_main_arr['sku_id'] > 0) {
                                        ...
                                        {
                                              echo '<tr style="background-color: red;color: white;"><td>' . $counter2 . '</td><td>' . $skuval['sku'] . '</td><td>' . $skuval['weight'] . ' KG</td><td>' . $skuval['piece'] . '</td><td>'.$total_weight.'</td><td>' . $sku_details . '</td></tr>';
                                        }
                                    }
                                    echo '</table>';
                                    ?>
