...
<!--                                                <div class="col-md-3"><div class="form-group" ><strong><?=lang('lang_Quantity');?>:</strong>
                                            ...
                                            <div class="col-lg-12" style="padding-left: 20px;padding-right: 20px;">
                                                ...
                                                <div class="col-md-5"><div class="form-group" >
                                                        ...
                                                        <button  class="btn btn-danger" ng-click="loadMore(1, 0);" >Load Data</button>
                                    ...
                                    <table class="table table-striped table-hover table-bordered dataTable" id="example" style="width:100%;">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th>COD Received 3pl</th>
                                                <th>COD Received DATE</th>
                                                <th>Area</th>
                                                <th>Street</th>
                                                <?php  if(menuIdExitsInPrivilageArray(230) == 'Y') {  ?>
                                                    <th>SAP No.</th>
...
<!--                                            <td>{{data.main_status}}</td>-->
                                           ...
                                           <div class="alert alert-success ">{{ days }} days, {{ hours }}:{{ minutes }}:{{ seconds }} </div> </span>
                                            ...
                                            <td><span class="label label-success" ng-if="data.pay_invoice_no== 'Y'">Yes</span>
                                                <span class="label label-warning" ng-if="data.pay_invoice_no!='Y'">No</span></td>
                                            
                                             <td>{{data.promise_deliver_date}}</td>
                                               <td>{{data.suggest_company}}</td>
                                               <td>{{data.cod_received_3pl}}</td>
                                               <td><span ng-if="data.cod_received_date!='0000-00-00'">{{data.cod_received_date}}</span></td>
                                               <td>{{data.area_name}}</td>
                                               <td>{{data.street_number}}</td>
                                               <?php  if(menuIdExitsInPrivilageArray(230) == 'Y') {  ?>
                                                <td>{{data.sap_order_number}}</td>
                                               <?php } ?>
...
<!--                                                            <li><a href="<?= base_url(); ?>Shipment/edit_view/{{data.id}}"><i class="icon-pencil7"></i> <?=lang('lang_Change_Destination');?> </a></li>    -->
                                                           ...
                                                           <!--  <li><a ng-if="data.delivered == 'OC' || data.code == 'PG' || data.code == 'AP' || data.code == 'PK'" class="dropdown-item" ng-click="GetProcessOpenOrder(data.slip_no);" ng-confirm-click="are you sure want to open order?"> <i class="fa fa-openid fa-fw"></i>Open Order</a> </li>  -->
                                                            ...
                                                            <?php  if(menuIdExitsInPrivilageArray(124) == 'Y' && $this->system_type == 'new') {  ?>
                                                               
                                                                <li ng-if="data.open_stock==1 && data.code == 'OC'"><a class="dropdown-item" ng-confirm-click="are you sure want to open order?" href="<?= base_url(); ?>Shipment_og/open_order/{{data.slip_no}}" > Open Order</a></li> 
                                                                <li ng-if="data.open_stock==0 && data.code == 'OC'"><a class="dropdown-item" ng-confirm-click="are you sure want to open order?" ng-click="GetorderopenCheck(data.slip_no);"> Open Order</a></li>
                                                            <?php }  ?>
                                                            <?php if (menuIdExitsInPrivilageArray(124) == 'Y' && $this->system_type == 'old') { ?>
                                                            <li>
                                                            ...
                                                            <?php } ?>
                                                              ...
                                                              <?php  if(menuIdExitsInPrivilageArray(230) == 'Y') {  ?>
                                                            <li><a href="{{data.invoice_label}}" target="blank"><i class="fa fa-print fa-fw"></i> Label Invoice </a></li>
                                                              <?php  } ?>
                                ...
                                <div class="col-md-12 row">
                                    ...
                                    <div class="col-sm-4">
                                        <label class="container">
                                            ...
                                            <input type="checkbox" name="destination_country" value=" Destination Country"  ng-model="listData2.destination_country"><?= lang('lang_Destination_country'); ?>
                                    ...
                                    <div class="col-sm-4">
                                        <label class="container">
                                            <input type="checkbox" name="area" value="area"   ng-model="listData2.area"> Area
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                  ...
                                  <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-4">
                                        <label class="container">
                                        <input type="checkbox" name="audit_status" value="audit_status"  ng-model="listData2.audit_status"> Audit Status 
                                            <span class="checkmark"></span>    
                                        </label>
                                    </div>
                                      <div class="col-sm-4">
                                        <label class="container">
                                        <input type="checkbox" name="suggest_company" value="suggest_company"  ng-model="listData2.suggest_company"> Suggest 3pl Company 
                                            <span class="checkmark"></span>    
                                        </label>
                                    </div>
                                    <div class="col-sm-4">
                                        <label class="container">
                                        <input type="checkbox" name="cod_received_3pl" value="cod_received_3pl"  ng-model="listData2.cod_received_3pl"> COD Received 3pl 
                                            <span class="checkmark"></span>    
                                        </label>
                                    </div>
                                    <div class="col-sm-4">
                                        <label class="container">
                                        <input type="checkbox" name="cod_received_date" value="cod_received_date"  ng-model="listData2.cod_received_date"> COD Received DATE 
                                            <span class="checkmark"></span>    
                                        </label>
                                    </div>
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-4">
                                        <label class="container">
                                        <input type="checkbox" name="on_hold" value="on_hold"  ng-model="listData2.on_hold"> On Hold
                                            <span class="checkmark"></span>    
                                        </label>
                                    </div>
