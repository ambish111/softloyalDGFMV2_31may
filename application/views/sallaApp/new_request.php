...
<html lang="en">
    <head>
        ...
        <title>Salla New Request</title>
        <?php $this->load->view('include/file'); ?>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.3/js/select2.min.js"></script>
        <script src="<?= base_url(); ?>assets/js/angular/sallaApp.app.js?v=<?= time(); ?>"></script>
    </head>
    <body ng-app="sallaApp" ng-controller="SallaAppCtlr" ng-init="showasallatemplatelist('');" >
                ...
                <div class="content-wrapper">
                    ...
                    <div class="content">
                        <div class="panel panel-flat">
                            <div class="panel-heading"><h1><strong>Salla New Request</strong></h1></div>
                            <hr>
                            <div class="panel panel-flat">
                                        ...
                                        <div class="table-responsive" style="padding-bottom:50px;" >
                                            ...
                                            <table class="table table-striped table-hover table-bordered dataTable" id="example" style="width:100%;">
                                                ...
                                                <tr ng-if='UserArr.listdata != 0' ng-repeat="data in UserArr.listdata"> 
                                                    <td>{{$index + 1}} </td>
                                                    <td>{{data.name}}</td> 
                                                    <td>{{data.log.data.merchant.name}} <br>({{data.log.data.merchant.domain}})</td> 
                                                    <td>{{data.email}}</td>
                                                    <td>{{data.mobile}}</td>
                                                    <td>
                                                        <span ng-if="data.status == 'L'">{{data.salla_shipping_cost}}</span>
                                                    </td>
                                                    <td>
                                                        ...
                                                        <ul class="icons-list">
                                                            <li class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-right">
                                                                    ...
                                                                    <?php if (menuIdExitsInPrivilageArray(244) == 'Y') { ?> 
                                                                    ...
                                                                    <?php } ?>
                                                                    <?php if (menuIdExitsInPrivilageArray(243) == 'Y') { ?>
                                                                    ...
                                                                    <?php } ?>
                                                                    <li><a ng-if="data.status == 'A'" ng-click="linkToSalla($index, data.id,data.app_mode);"  ><i class="icon-pencil7"></i>Link To Salla</a></li>
                                                                </ul>
                                                            </li>
                                                        </ul>
                                                    </td>
                            ...
                            <div style="padding-top:50px;">
                             ...
                             <div style="padding-top:50px;">
                                ...
                                <div  style="padding-top:50px;">
                                    <b>Shipping Cost</b>
                                    <div>
                                        <input type="number" class="form-control" ng-model="newCustArr.main.salla_shipping_cost"  value="" pacleholder="Shipping Cost" required  >
                                    </div>
                                </div>    
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" ng-click="close_model();"  ><?= lang('lang_Close'); ?></button>
                            <button  type="button" class="btn btn-primary" ng-click="sallaupactive_new(newCustArr.main,newCustArr.type_new);" >Assing Salla</button>
                        </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-12" ng-if="messArray1 != 0">
                                ...
                                <div ng-show="linkbutton"  style="padding-top:50px;">
                                    ...
                                    <div>
                                        <select  ng-model="AssignData.customer_id" data-show-subtext="true" data-live-search="true" class="selectpicker" data-width="100%" required  data-placeholder="Choose Customer">
                                            <option ng-repeat="cx in UserArr.customer"  value="{{cx.id}}">{{cx.company}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div ng-show="linkbutton"  style="padding-top:50px;">
                        ...
                        <div class="modal-footer">
                            ...
                            <button id="assing_btn" ng-if="AssignData.assign_type == 'Link'" type="button" disabled  class="btn btn-primary" ng-click="saveassigntosalla();" >Assing Salla</button>
                        </div>
                        </form>          
                    </div>
                </div>
