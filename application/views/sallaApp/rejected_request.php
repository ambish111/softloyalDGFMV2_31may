...
<html lang="en">
    <head>
        ...
        <script src="<?= base_url(); ?>assets/js/angular/sallaApp.app.js"></script>
    </head>

    <body ng-app="sallaApp" ng-controller="SallaAppCtlr" ng-init="showasallatemplatelist('R');" >
                    ...
                    <div class="content" > 
                        ...
                        <div class="panel panel-flat" > 
                            ...
                            <div class="panel-heading" dir="ltr"> 
                                ...
                                <h1><strong>Rejected Request</strong></h1>
