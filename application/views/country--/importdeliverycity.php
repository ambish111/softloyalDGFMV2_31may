                    ...
                    <div class="content">
                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body">
                                  <div class="panel-heading"><h1><strong>Import Delivery City</strong><a href="<?= base_url('Excel_export/ImportDeliveryCityFile'); ?>"><i class="icon-file-excel pull-right" style="font-size: 35px;"></i></a></h1></div>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>(1) City <span style="color:#F00"><strong>*</strong></span></td>
                                            <?php
