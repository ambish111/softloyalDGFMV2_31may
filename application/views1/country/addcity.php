                            ...
                            <div class="panel-body">
                                ...
                                <form action="<?= base_url('country/addcitybtn'); ?>" name="adduser" method="post">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label for="arabic_city"><strong><?=lang('lang_Arabic_City_Name');?>:</strong></label>
                                       <input type="text" class="form-control" name='title' id="country" placeholder="Enter Arabic City Name" value="<?=$EditData['title'];?>">
                                    </div>
