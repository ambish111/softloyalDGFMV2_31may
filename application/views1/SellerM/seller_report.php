                    ...
                    <div class="panel bg-teal-400">
                      ...
                      <div class="panel-body" style="height:300px">
                        ...
                        <div class="icon-pin-alt" style="padding-bottom: 10px;"> <?= $customer_info->address;?></div><br> 
                         ...
                         <a href="<?=FBASEURL;?><?= $customer_info->upload_cr;?>" class="btn btn-success" style="color:white;" target="_blank">Uploaded CR</a> 
                         </div><br>   
                         <div class="icon-file-pdf" style="padding-bottom: 10px; "> 
                        
                         <a href="<?=FBASEURL;?><?= $customer_info->upload_id;?>" class="btn btn-success" style="color:white;" target="_blank">Uploaded ID</a> 
                        </div><br>   
                         <div class="icon-file-pdf" style="padding-bottom: 10px; "> 
                        
                         <a href="<?=FBASEURL;?><?= $customer_info->upload_contact;?>" class="btn btn-success" style="color:white;" target="_blank">Uploaded Contract	</a></div><br>   
