                            ...
                            <div class="row" >
                                <div class="col-lg-12" >
                                    ...
                                    <div class="panel panel-flat" dir="ltr">
                                        ...
                                        <form method="post" action="<?= base_url(); ?>report_3pl">
...
<div class="col-md-4"><div class="form-group" ><strong></strong><br/><button type="submit"  class="btn btn-danger"- ><?= lang('lang_Get_Details'); ?></button>
              ...
              <!-- <input type="text" id="search"  placeholder="Search .." class="form-control">
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($sellers)) {
                                                ...
                                                foreach ($sellers as $seller) {
                                                    ...
                                                    $running = GetdeliveryreportArr($seller->cc_id, 'running');

                                                    $totalrun = $delivered + $Not_delivered;
                      ...
                      <td><a href="' . base_url() . 'performance_details_3pl/' . $seller->cc_id . '/7/' . $from_date . '/' . $to_date . '" target="_blank"><span class="btn btn-success">' . $delivered . ' </span></a></td>
					  <td><a href="' . base_url() . 'performance_details_3pl/' . $seller->cc_id . '/8/' . $from_date . '/' . $to_date . '" target="_blank"><span class="btn btn-danger">' . $Not_delivered . ' </span></a></td>
					<!--  <td><a href="' . base_url() . 'performance_details_3pl/' . $seller->cc_id . '/running/' . $from_date . '/' . $to_date . '"><span class="btn btn-warning">' . $running . '</span></a> </td>-->
    ...
    <div class="modal-dialog" >
      <div class="modal-content">
		...
		function chartcheckdetail(poid,deli,ndeli,ofd)
			{
				...
				var total=parseInt(deli)+parseInt(ndeli);
		...
		type: \'doughnut\',
		data: {
		  labels: ["Delivered %", "Return %"],
		  datasets: [
			{
			  label: "Shipment Details",
			  backgroundColor: ["#FF5722","green","red"],
			  data: [delipersent.toFixed(2),ndelipersent.toFixed(2)]
			}
		  ]
		},
		 options: {
        ...
        <canvas id="doughnut-chart' . $seller->id . '" style="width:20%; height:20%;"></canvas>
					...
					';
                                                ...
                                                //echo $totalshow_deliverdnot; die;

                                                echo'<tr><td colspan="2">&nbsp;</td>
		<td><a href="' . base_url() . 'performance_details_3pl/0/7/' . $from_date . '/' . $to_date . '"><span class="btn btn-success">' . $totalshow_deliverd . '</span></a></td>
		<td><a href="' . base_url() . 'performance_details_3pl/0/8/' . $from_date . '/' . $to_date . '"><span class="btn btn-danger">' . $totalshow_deliverdnot . '</span></a></td>
		<!--<td><a href="' . base_url() . 'performance_details_3pl/0/running/' . $from_date . '/' . $to_date . '"><span class="btn btn-warning">' . $totalshow_deliverdruning . '</span></a></td><td colspan="3">&nbsp;</td>--></tr>';
                                            }
                                            ?>
                                        </tbody>
                                    </table>
