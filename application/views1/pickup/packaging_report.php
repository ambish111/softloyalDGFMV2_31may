                                                ...
                                                <table class="table table-bordered table-hover" style="width: 100%;">
                                                    ...
                                                    <tbody >
                                                        <tr style="width: 80%;">
                                                            ...
                                                            <td><button  class="btn btn-danger" ng-click="loadMore1(1, 0);" ><?= lang('lang_Get_Details'); ?></button></td>          
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <br>
                        ...
                        <div class="panel panel-flat" >
                            <div class="panel-body" >
                                <div class="table-responsive" style="padding-bottom:20px;" id="printTable" > 
                                    ...
                                    <table ng-show="tableshow" class="table table-striped table-hover table-bordered display nowrap"  style="width:100%;">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="data in showlistData1">
                                    ...
                                    <button ng-hide="showlistData1.length == totalCount" class="btn btn-info" ng-click="loadMore1(count = count + 1, 0);" ng-init="count = 1">Load More</button>
                                </div>
