			...
			<div class="content-wrapper">
				...
				<div class="content" >
					<div class="panel panel-flat">
						<div class="panel-heading"><h1><strong>Add Item Category</strong></h1></div>
						<hr>
						<div class="panel-body" style="padding-bottom:200px;">


							<form id="form" action="<?= base_url('ItemCategory/add');?>" method="post">
								...
								<!-- <div class="form-group">
                                    ...
                                    <label for="exampleInputEmail1"><strong>Main Category:</strong></label>
										 ...
										 <select  id="dd_category" name="dd_category" class="bootstrap-select"  data-width="100%" >
