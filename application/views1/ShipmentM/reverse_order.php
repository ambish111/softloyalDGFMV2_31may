...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="<?= base_url(); ?>assets/js/angular/reverseorder.app.js"></script>
    </head>
    ...
    <body ng-app="Appdispatched" >
        ...
        <!-- Page container -->
        <div class="page-container" ng-controller="CTLRdelivered" ng-init="loadMore(1, 0);">
                            ...
                            <div class="col-lg-12" >
                                ...
                                <div class="panel panel-flat">
                                    <div class="panel-heading">
                                        <h1> <strong>Reverse orders</strong> 
                                            <!--  <a  ng-click="exportdispatchForLm();" >-->
                                            <a  ng-click="getExcelDetailsDelivered();" >
...
<!-- <a id="pdf" ><i class="icon-file-pdf pull-right" style="font-size: 35px;color: red;"></i></a> --> 
                                    ...
                                    <!-- href="<? //base_url('Pdf_export/all_report_view');   ?>" --> 
                                        ...
                                        <div class="panel-body" >
                                            <div class="col-lg-12" style="padding-left: 20px;padding-right: 20px;"> 
                                                ...
                                                <!-- <div class="panel-body" > -->
                                                <div class="col-md-3"><div class="form-group" ><strong><?= lang('lang_AWB'); ?>:</strong> <br>
                                                ...
                                                <div class="col-md-3">  <div class="form-group" ><strong><?= lang('lang_AWB_value'); ?>:</strong>
                                                ...
                                                <div class="col-md-3"> <div class="form-group" ><strong><?= lang('lang_TPL_company'); ?>:</strong>
                                                        <br>
                                                        <?php
                                                ...
                                                <div class="col-md-2" style="margin-top:20px"><div class="form-group" >
                                                    ...
                                                    <div class="col-md-3"> <div class="form-group" ><button type="button" class="btn btn-success" ><?= lang('lang_Total'); ?> <span class="badge">{{shipData.length}}/{{totalCount}}</span></button>
                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>COD(<?=  $this->deafult_currency; ?>)</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                        ...
                        <div id="excelcolumnDelivered" class="modal fade">   
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="row" style="padding-left: 40%;padding-top: 10px;">   
                                                ...
                                                <button type="submit" class="btn btn-info pull-left" name="shipment_transfer" ng-click="transferShipDelivered(listData2, listData1.exportlimit);">Download</button>  
                                            </div>
...
<!-- <th>Cartoon Quantity</th> -->
            ...
            <script>
                       ...
                       var todaysDate = 'Dispatched Details ' + new Date();                                        var blobURL = tableToExcel('downloadtable', 'test_table');
