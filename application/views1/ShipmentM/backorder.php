...
<script type="text/javascript" src="<?=base_url();?>assets/js/angular/backorder.app.js"></script>

</head>

<body ng-app="Appbackorderlist" >
...
<!-- Page container -->
<div class="page-container" ng-controller="backorderview" ng-init="loadMore(1,0);">
...
?>
<div class="alert alert-warning" ng-repeat="err in errorBackorder"> this  sku {{err.sku}}  Qty {{err.qty}} or pallet no. not available <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>
                ...
                <div class="panel-heading">
                 <h1>
                  <strong>Back Order</strong> 
				   <a  ng-click="exportExcel('#downloadtable');" ><i class="icon-file-excel pull-right" style="font-size: 35px;"></i></a>    
                      ...
                      <tr style="width: 80%;">
                       ...
                       <td>
                        ...
                        <td><button  class="btn btn-danger" ng-click="loadMore(1,1);" >Search</button></td>
                         <td><button  class="btn btn-info" ng-click="generatePickup();" >Create Order</button></td>  
...
<th>Date </th>
    ...
    <tr ng-if='shipData!=0' ng-repeat="data in shipData"> 
        ...
        <td>{{$index+1}} <input type="checkbox" ng-if="data.reciever_name!='' && data.reciever_phone!=''" value="{{data.slip_no}}" check-list='Items' ng-model="data.Selected" ng-click="checkIfAllSelected()" /> 
        <input type="checkbox" ng-if="data.reciever_name=='' || data.reciever_phone==''" disabled value="{{data.slip_no}}" check-list='Items' ng-model="data.Selected" ng-click="checkIfAllSelected()" /></td>
        <td>{{data.slip_no}}</td>
