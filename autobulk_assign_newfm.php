...
//echo json_encode($exportDataArr);die;
...
//    echo json_encode($slipData); die; 
foreach($slipData as $s)
{
    
    sleep(2);
    $param = array('super_id' =>$super_id,'slip_no'=>$s,'cc_id'=>$exportDataArr['param']['cc_id'],'comment'=>$exportDataArr['param']['comment'],'box_pieces'=>$exportDataArr['param']['box_pieces'],'open_package_flag'=>$open_package_flag,'id'=>$exportDataArr['param']['id']);
